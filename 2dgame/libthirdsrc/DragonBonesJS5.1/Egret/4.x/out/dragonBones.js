...
(function (dragonBones) {
    ...
    var Slot = (function (_super) {
        ...
        //yangguiming 用于真正显示childIndex
        Slot.prototype._setZorderChildIndex = function (value) {
            this._zOrderChildIndex = value;
            this._zOrderDirty = true;
        };
        /**
         * @internal
...
(function (dragonBones) {
    ...
    var EgretSlot = (function (_super) {
        ...
        EgretSlot.prototype._updateZOrder = function () {
            //modify:yangguiming 原来zorder用于逻辑排序，_zOrderChildIndex才是真正的设置位置
            var _zOrder = this._zOrderChildIndex;
            if (this._armatureDisplay._batchEnabled) {
                var nodes = this._armatureDisplay.$renderNode.drawData;
                nodes[_zOrder] = this._renderDisplay.$renderNode;
            }
            else {
                ...
                this._armatureDisplay.addChildAt(this._renderDisplay, _zOrder);
            }
        };
        /**
         * @internal
