...
var GuideActionSpace;
(function (GuideActionSpace) {
    GuideActionSpace.executeActionHandler = {};
    function clearAction(param, _guideIndex, _actionIndex, args) {
        ...
        var guideIndex = param["index"][0];
        var actionIndex = param["index"][1];
    ...
    GuideActionSpace.executeActionHandler[GuideListenDefine.FIELD_ACTION_CLEARACTION] = clearAction;
    function showTipsFrame(param, guideIndex, actionIndex, args) {
        //TLog.Debug("executeActionHandler: showTipsFrame!")
        var loadCallback = function (parentWnd) {
            ...
            var frame = WngMrg.getInstance().createWindow("GuideTipsFrame");
    ...
    GuideActionSpace.executeActionHandler[GuideListenDefine.FIELD_ACTION_TIPS] = showTipsFrame;
    function showDramaTipsFrame(param, guideIndex, actionIndex, args) {
        //TLog.Debug("showDramaTipsFrame")
        var frame = WngMrg.getInstance().getWindow("DramaTipsFrame");
    ...
    GuideActionSpace.executeActionHandler[GuideListenDefine.FIELD_ACTION_DRAMATIPS] = showDramaTipsFrame;
    function showAnimTipsFrame(param, guideIndex, actionIndex, args) {
        ...
        var loadCallback = function (parentWnd) {
            ...
            //	return
            //}	
            var frame = WngMrg.getInstance().createWindow("AnimTipsFrame");
    ...
    GuideActionSpace.executeActionHandler[GuideListenDefine.FIELD_ACTION_ANIMTIPS] = showAnimTipsFrame;
    //可移动的动画（手指）
    function showMovableAnimTipsFrame(param, guideIndex, actionIndex, args) {
        var loadCallback = function (parentWnd) {
            ...
            var frame = WngMrg.getInstance().createWindow("MovableAnimTipsFrame");
            if (!this.saveAnimTipsFrameIndex) {
                this.saveAnimTipsFrameIndex = 1;
            }
            else {
    ...
    GuideActionSpace.executeActionHandler[GuideListenDefine.FIELD_ACTION_MOVABLEANIMTIPS] = showMovableAnimTipsFrame;
    ...
    GuideActionSpace.executeActionHandler[GuideListenDefine.FIELD_ACTION_RECORD] = recordString;
    ...
    GuideActionSpace.executeActionHandler[GuideListenDefine.FIELD_ACTION_DELETE_LISTEN] = deleteListen;
    function addListen(param, guideIndex, actionIndex, args) {
        this.addListener(param["listen"]);
        TLog.Debug("addListen", param["listen"]);
        //io.read()
    }
    GuideActionSpace.executeActionHandler[GuideListenDefine.FIELD_ADD_LISTEN] = addListen;
    function showCreatMask(param, guideIndex, actionIndex, args) {
        ...
        var loadCallback = function (parentWnd) {
            if (this.isMarkInsertWindow(guideIndex, actionIndex) == false)
                return;
            var rootWndName = null;
            var window = null;
            if (param["window"]) {
                var wndList = splitString(param["window"], '/');
            ...
            var frame = WngMrg.getInstance().createWindow("GuideMaskFrame");
    ...
    GuideActionSpace.executeActionHandler[GuideListenDefine.FIELD_CREAT_MASK] = showCreatMask;
    function doEvent(param, guideIndex, actionIndex, args) {
        //TLog.Debug("doEvent",guideIndex,actionIndex,args)
        var listen = param["listen"];
        this.doGuideByIndex(listen);
    }
    GuideActionSpace.executeActionHandler[GuideListenDefine.FIELD_DO_EVENT] = doEvent;
    ...
    GuideActionSpace.executeActionHandler[GuideListenDefine.FIELD_ACTION_PICKSEX] = showPickSexFrame;
    ...
    GuideActionSpace.executeActionHandler[GuideListenDefine.FIELD_ACTION_SHOUGROWFRAME] = showGrowFrame;
    ...
    GuideActionSpace.executeActionHandler[GuideListenDefine.FIELD_ACTION_REFRESHPETFRAME] = refreshPetFrame;
    function showBtnTips(param, guideIndex, actionIndex, args) {
        var type = param["type"];
        GuideFuncSystem.getInstance().showDynamicTips(type);
    }
    GuideActionSpace.executeActionHandler[GuideListenDefine.FIELD_SHOW_BTN_TIPS] = showBtnTips;
    function hideBtnTips(param, guideIndex, actionIndex, args) {
        var type = param["type"];
        GuideFuncSystem.getInstance().hideDynamicTips(type);
    }
    GuideActionSpace.executeActionHandler[GuideListenDefine.FIELD_HIDE_BTN_TIPS] = hideBtnTips;
    function playMovie(param, guideIndex, actionIndex, args) {
        //TLog.Debug("doEvent",guideIndex,actionIndex,args)
        var movieName = param["movieName"];
        MovieSystem.getInstance().beginPlay(movieName);
    }
    GuideActionSpace.executeActionHandler[GuideListenDefine.FIELD_PLAY_MOVIE] = playMovie;
    function channelTips(param, guideIndex, actionIndex, args) {
        //TLog.Debug("doEvent",guideIndex,actionIndex,args)
        if (param["shengdi"] == true) {
            var name1 = RandomRobotName();
            var name2 = RandomRobotName();
    ...
    GuideActionSpace.executeActionHandler[GuideListenDefine.FIELD_SHOW_CHANNELTIPS] = channelTips;
    ...
    GuideActionSpace.executeActionHandler[GuideListenDefine.FIELD_ACTION_REFRESHPETTAB] = refreshPetTab;
})(GuideActionSpace || (GuideActionSpace = {}));
//# sourceMappingURL=GuideExecuterHandler.js.map