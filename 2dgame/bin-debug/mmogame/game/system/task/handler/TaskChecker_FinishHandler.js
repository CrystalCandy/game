...
*/
var TaskFinishSpace;
(function (TaskFinishSpace) {
    function compareMax(task, param) {
        var taskInfo = task.getPropertyInfo();
        var data = taskInfo.data[param];
        var finish = taskInfo.finish[param];
        return data > finish;
    }
    ...
    TaskFinishSpace.TaskFinishHandle = (_a = {},
        //服务器判断
        _a[taskFinishId.R_SKILL_MAX_LV] = compareMaxEqual,
        _a[taskFinishId.R_SKILL_UP_NUM] = compareMaxEqual,
        _a[taskFinishId.R_EQUIP_MAX_NUM] = compareMaxEqual,
        _a[taskFinishId.R_EQUIP_CHANGE_NUM] = compareMaxEqual,
        _a[taskFinishId.R_EQ_QH_MAX_LEVEL] = compareMaxEqual,
        _a[taskFinishId.R_EQ_QH_MIN_LEVEL] = compareMaxEqual,
        _a[taskFinishId.R_EQ_QH_NUM] = compareMaxEqual,
        _a[taskFinishId.R_EQ_JL_MAX_LEVEL] = compareMaxEqual,
        _a[taskFinishId.R_EQ_JL_MIN_LEVEL] = compareMaxEqual,
        _a[taskFinishId.R_EQ_JL_NUM] = compareMaxEqual,
        _a[taskFinishId.R_EQ_DL_MAX_LEVEL] = compareMaxEqual,
        _a[taskFinishId.R_EQ_DL_MIN_LEVEL] = compareMaxEqual,
        _a[taskFinishId.R_EQ_DL_NUM] = compareMaxEqual,
        _a[taskFinishId.R_EQ_BS_MAX_LEVEL] = compareMaxEqual,
        _a[taskFinishId.R_EQ_BS_MIN_LEVEL] = compareMaxEqual,
        _a[taskFinishId.R_EQ_BS_NUM] = compareMaxEqual,
        _a[taskFinishId.R_EQ_MELT_NUM] = compareMaxEqual,
        _a[taskFinishId.ROLE_WORLD_TALK_NUM] = compareMaxEqual,
        _a[taskFinishId.CAMPAIGN_ID] = compareMaxEqual,
        _a[taskFinishId.CAMPAIGN_NUM] = compareMaxEqual,
        _a[taskFinishId.CAMPAIGN_SET_AUTO] = compareEqual,
        _a[taskFinishId.ENTRY_MAP] = compareEqual,
        _a[taskFinishId.PET_COUNT] = compareMaxEqual,
        _a[taskFinishId.PET_STAGE_STEP_NUM] = compareMaxEqual,
        _a[taskFinishId.PET_STAGE_MAX_LV] = compareMaxEqual,
        _a[taskFinishId.XL_COUNT] = compareMaxEqual,
        _a[taskFinishId.XL_STAGE_STEP_NUM] = compareMaxEqual,
        _a[taskFinishId.XL_STAGE_MAX_LV] = compareMaxEqual,
        _a[taskFinishId.RIDE_STAGE_STEP_NUM] = compareMaxEqual,
        _a[taskFinishId.RIDE_STAGE_LEVEL] = compareMaxEqual,
        _a[taskFinishId.WING_STAGE_STEP_NUM] = compareMaxEqual,
        _a[taskFinishId.WING_STAGE_LEVEL] = compareMaxEqual,
        _a[taskFinishId.TONGLIN_STAGE_STEP_NUM] = compareMaxEqual,
        _a[taskFinishId.TONGLIN_STAGE_LEVEL] = compareMaxEqual,
        _a[taskFinishId.SOUHUN_STAGE_STEP_NUM] = compareMaxEqual,
        _a[taskFinishId.SOUHUN_STAGE_LEVEL] = compareMaxEqual,
        _a[taskFinishId.FAZHEN_STAGE_STEP_NUM] = compareMaxEqual,
        _a[taskFinishId.FAZHEN_STAGE_LEVEL] = compareMaxEqual,
        _a[taskFinishId.XIANWEI_STAGE_STEP_NUM] = compareMaxEqual,
        _a[taskFinishId.XIANWEI_STAGE_LEVEL] = compareMaxEqual,
        _a[taskFinishId.TX_STAGE_STEP_NUM] = compareMaxEqual,
        _a[taskFinishId.TX_STAGE_LEVEL] = compareMaxEqual,
        _a[taskFinishId.TXWEAPON_STAGE_STEP_NUM] = compareMaxEqual,
        _a[taskFinishId.TXWEAPON_STAGE_LEVEL] = compareMaxEqual,
        _a[taskFinishId.TN_STAGE_STEP_NUM] = compareMaxEqual,
        _a[taskFinishId.TN_STAGE_LEVEL] = compareMaxEqual,
        _a[taskFinishId.TNXIANQI_STAGE_STEP_NUM] = compareMaxEqual,
        _a[taskFinishId.TNXIANQI_STAGE_LEVEL] = compareMaxEqual,
        _a[taskFinishId.TNHUANIAN_STAGE_STEP_NUM] = compareMaxEqual,
        _a[taskFinishId.TNHUANIAN_STAGE_LEVEL] = compareMaxEqual,
        _a[taskFinishId.TNLINGQI_STAGE_STEP_NUM] = compareMaxEqual,
        _a[taskFinishId.TNLINGQI_STAGE_LEVEL] = compareMaxEqual,
        _a[taskFinishId.ROLE_MAX_LEVEL] = compareMaxEqual,
        _a[taskFinishId.ROLE_LEVEl_NUM] = compareMaxEqual,
        _a[taskFinishId.COPY_PERSON_COUNT] = compareMaxEqual,
        _a[taskFinishId.COPY_PERSON_NUM] = compareMaxEqual,
        _a[taskFinishId.COPY_DRAGON_LEVEL] = compareEqual,
        _a[taskFinishId.COPY_DRAGON_MAX] = compareMaxEqual,
        _a[taskFinishId.COPY_DRAGON_NUM] = compareMaxEqual,
        _a[taskFinishId.COPY_DRAGON_START_NUM] = compareMaxEqual,
        _a[taskFinishId.COPY_MATERIAL_COUNT] = compareEqual,
        _a[taskFinishId.COPY_MATERIAL_NUM] = compareMaxEqual,
        _a[taskFinishId.COPY_ZHONGKUI_COUNT] = compareMaxEqual,
        _a[taskFinishId.COPY_ZHONGKUI_NUM] = compareMaxEqual,
        _a[taskFinishId.COPY_THUNDER_MAX] = compareMaxEqual,
        _a[taskFinishId.COPY_THUNDER_NUM] = compareMaxEqual,
        _a[taskFinishId.COPY_TEAM_COMBAT_NUM] = compareMaxEqual,
        _a[taskFinishId.CHAMPION_NUM] = compareMaxEqual,
        _a);
    var _a;
})(TaskFinishSpace || (TaskFinishSpace = {}));
...
// ["BATTLE"]              : shouldFinish, 
//# sourceMappingURL=TaskChecker_FinishHandler.js.map