...
var TaskFindNpcSpace;
(function (TaskFindNpcSpace) {
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////
    TaskFindNpcSpace.NpcInTaskHandle = {}; //检查NPC是不是在任务中需要的，如果是，则提示可以接（例如访问NPC等其他任务）
    ...
    // 		if (table_isExsit(taskInfo.finish[taskField.FIELD_FINISH_FINDNPC], npcId)) {
    // 			shouldFind = true
    // 		}
    // 		return shouldFind
    // 	}
    ...
    TaskFindNpcSpace.NpcInTaskHandle["FIGHTWIN_NPC"] = fightNpc;
    function qestionNpc(task, npcId) {
        var taskInfo = task.getPropertyInfo();
        return taskInfo.finish[taskField.FIELD_FINISH_FINDNPC][0] == npcId;
    }
    TaskFindNpcSpace.NpcInTaskHandle["FEIXINGQ_QUESTION"] = qestionNpc;
})(TaskFindNpcSpace || (TaskFindNpcSpace = {}));
//# sourceMappingURL=TaskChecker_FindNpcHandler.js.map