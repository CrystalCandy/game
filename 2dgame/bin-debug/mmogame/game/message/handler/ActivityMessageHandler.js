...
*/
var ActivityMessageHandler = (function (_super) {
    __extends(ActivityMessageHandler, _super);
    function ActivityMessageHandler() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    ActivityMessageHandler.prototype.initObj = function () {
        var args = [];
    ...
    //签到
    ActivityMessageHandler.prototype.onRecvG2C_QIANDAO_TIME = function (dispatcher, message) {
        TLog.Debug("ActivityDefine.Welfare", ActivityDefine.Welfare);
        var a = GetActivity(ActivityDefine.Welfare);
        a.updateQiandaoData(message.times, message.isget);
    };
    //-活动更新BUFF
    ActivityMessageHandler.prototype.onRecvG2C_BUFF_UPDATE = function (dispatcher, message) {
    ...
    //-混沌世界移除BUFF
    ActivityMessageHandler.prototype.onRecvG2C_BUFF_REMOVE = function (dispatcher, message) {
        BuffSystem.getInstance().removeActBuff(message.buffName);
        FireEvent(EventDefine.ACTIVITY_BUFF_UPDATE, null);
    };
    ActivityMessageHandler.prototype.onRecvG2C_ROLE_RANK = function (dispatcher, message) {
    ...
    // 	FireEvent(EventDefine.ACTIVITY_GLOBAL_SERVER_EVENT, NetMessageEvent.newObj(message))
    // 	//ClubSystem.getInstance().handleClubEvent(message.event)
    // }
    ////////////////////////////////////////////////////////////////
    //贵族答题
    ActivityMessageHandler.prototype.onRecvG2C_WORLDQUESTION_ENTER = function (dispatcher, message) {
        GetActivity(ActivityDefine.AnswerQuestion).start();
    };
    ActivityMessageHandler.prototype.onRecvG2C_WORLDQUESTION_QUESTION = function (dispatcher, message) {
    ...
    ActivityMessageHandler.prototype.onRecvG2C_WORLDQUESTION_INFO = function (dispatcher, message) {
    ...
    ActivityMessageHandler.prototype.onRecvG2C_WORLDQUESTION_ANSWER = function (dispatcher, message) {
    ...
    ActivityMessageHandler.prototype.onRecvG2C_WORLDQUESTION_LEAVE = function (dispatcher, message) {
        GetActivity(ActivityDefine.AnswerQuestion).stop();
    };
    ActivityMessageHandler.prototype.onRecvG2C_WORLDQUESTION_QUERY = function (dispatcher, message) {
    ...
    // ////////////////////////////////////////////////////////////////
    //日常活动状态
    ActivityMessageHandler.prototype.onRecvG2C_ACTIVITY_TIME_INFO = function (dispatcher, message) {
    ...
    // }
    // ////////////////////////////-航海（矿洞）//}////////////////////////////////////////////-
    ActivityMessageHandler.prototype.onRecvG2C_INVITE_PRIZE_INFO = function (dispatcher, message) {
        FireEvent(EventDefine.INVITE_PRIZE_INFO, NetMessageEvent.newObj(message));
    };
    ActivityMessageHandler.prototype.onRecvG2C_FRIEND_INVITE_CODE_INFO = function (dispatcher, message) {
    ...
    // ////////////////////////////////冲榜////////////////////////////////
    ActivityMessageHandler.prototype.onRecvG2C_NEW_SERVER_RANK_INFO = function (dispatcher, message) {
        ActivitySystem.getInstance().setOpenTime(message.openTime);
        SetServerOpenTime(message.openTime);
    };
    return ActivityMessageHandler;
}(MessageHandler));
__reflect(ActivityMessageHandler.prototype, "ActivityMessageHandler");
//# sourceMappingURL=ActivityMessageHandler.js.map