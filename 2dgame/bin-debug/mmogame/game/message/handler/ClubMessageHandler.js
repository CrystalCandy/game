...
var ClubMessageHandler = (function (_super) {
    __extends(ClubMessageHandler, _super);
    function ClubMessageHandler() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    ClubMessageHandler.prototype.initObj = function () {
        var args = [];
    ...
    ClubMessageHandler.prototype.onRecvG2C_ROLE_APPLY_FACTION_LIST = function (dispatcher, message) {
    ...
    ClubMessageHandler.prototype.onRecvG2C_FACTION_SELF_UPDATE = function (dispatcher, message) {
    ...
    ClubMessageHandler.prototype.onRecvG2C_FACTION_INTRODUCTION = function (dispatcher, message) {
        //获取公会信息
        ClubSystem.getInstance().onUpdateIntro(message.strTarget, message.legionID);
    };
    ClubMessageHandler.prototype.onRecvG2C_FACTION_INFO_REFRESH = function (dispatcher, message) {
        ClubSystem.getInstance().setCurClubInfo(message.clubInfo);
        FireEvent(EventDefine.GET_CLUB_INFO, null);
    };
    ClubMessageHandler.prototype.onRecvG2C_FACTION_INFO = function (dispatcher, message) {
    ...
    ClubMessageHandler.prototype.onRecvG2C_FACTION_APPLY_REFRESH = function (dispatcher, message) {
    ...
    //}
    ClubMessageHandler.prototype.onRecvG2C_FACTION_MEMBER_REFRESH = function (dispatcher, message) {
        ClubSystem.getInstance().setClubMenberList(message.menberList);
        FireEvent(EventDefine.GET_CLUB_MENBER_LIST, null);
    };
    ClubMessageHandler.prototype.onRecvG2C_FACTION_SINGLE_MEMBER_REFRESH = function (dispatcher, message) {
    ...
    ClubMessageHandler.prototype.onRecvG2C_FACTION_SKILLS_REFRESH = function (dispatcher, message) {
        // ClubSystem.getInstance(). setStudySkillList(message.studySkillList)
        // FireEvent(EventDefine.GET_CLUB_STUDY_SKILL_LIST, null)
    };
    ////////////////////////////////////////////////////////////////////-
    //-团长分配物品返回
    ClubMessageHandler.prototype.onRecvG2C_FACTION_ITEM_CHOOSE = function (dispatcher, message) {
    ...
    //}
    //-帮派仓库分配记录
    ClubMessageHandler.prototype.onRecvG2C_FACTION_ALLOCA_RECORD = function (dispatcher, message) {
    ...
    // }
    //-军团仓库物品
    ClubMessageHandler.prototype.onRecvG2C_FACTION_WAREHOUSE_LIST = function (dispatcher, message) {
    ...
    // 	activity.updateMessageHandler(message)
    // }
    ClubMessageHandler.prototype.onRecvCLUB_MESSAGE = function (dispatcher, message) {
        ClubSystem.getInstance().updateMessageHandler(message);
    };
    ClubMessageHandler.prototype.onRecvG2C_FACTIONWAR_AUTO_APPLY = function (dispatcher, message) {
        ClubSystem.getInstance().setAutoApplyStatus(message.autoStatus);
        FireEvent(EventDefine.FACWAR_AUTO_APPLY_STATUS, null);
    };
    //////////////////////////////////////
    ClubMessageHandler.prototype.onRecvG2C_FACTION_TASK_POINT_RANK = function (dispatcher, message) {
        FireEvent(EventDefine.FAC_TASK_POINT_RANK_UPDATE, NetMessageEvent.newObj(message));
    };
    ClubMessageHandler.prototype.onRecvG2C_FACTION_TASK_INFO_LIST = function (dispatcher, message) {
    ...
    ClubMessageHandler.prototype.onRecvG2C_FACTION_TASK_INFO_UPDATA = function (dispatcher, message) {
        FireEvent(EventDefine.FAC_TASK_ONE_UPDATE, NetMessageEvent.newObj(message));
    };
    ClubMessageHandler.prototype.onRecvG2C_FACTION_TASK_RANK_INFO = function (dispatcher, message) {
    ...
    // 	}
    // }
    ClubMessageHandler.prototype.onRecvG2C_FACTION_TREA_HOUSE_RECORD = function (dispatcher, message) {
        FireEvent(EventDefine.FAC_TASK_TREA_RECORD_UPDATE, NetMessageEvent.newObj(message));
    };
    ClubMessageHandler.prototype.onRecvG2C_FACTION_TASK_RANK_PRIZE = function (dispatcher, message) {
        FireEvent(EventDefine.FAC_TASK_RANK_RESULT_LIST, NetMessageEvent.newObj(message));
    };
    return ClubMessageHandler;
}(MessageHandler));
__reflect(ClubMessageHandler.prototype, "ClubMessageHandler");
//# sourceMappingURL=ClubMessageHandler.js.map