...
var LoginMessageHandler = (function (_super) {
    __extends(LoginMessageHandler, _super);
    function LoginMessageHandler() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    LoginMessageHandler.prototype.initObj = function () {
        var params = [];
    ...
    LoginMessageHandler.prototype.destory = function () {
        if (this.scheduleEntryID) {
            KillTimer(this.scheduleEntryID);
            this.scheduleEntryID = null;
        }
    };
    LoginMessageHandler.prototype.onTcpConnect = function (dispatcher, message) {
        if (message.code != 0) {
        ...
        if (this.scheduleEntryID == null) {
            var index = 0;
            var scheduTimerCallback = function (dt) {
                index = index + 1;
    ...
    LoginMessageHandler.prototype.onTcpClose = function (dispatcher, message) {
        //if(message.code ~= 0){
        if (message.code != 0) {
    ...
    LoginMessageHandler.prototype.onRecvL2C_CONNECT = function (dispatcher, message) {
    ...
    LoginMessageHandler.prototype.onRecvL2C_VERVIRY_CODE = function (dispatcher, message) {
    ...
    LoginMessageHandler.prototype.onRecvSMSG_LOGIN_USER = function (dispatcher, message) {
        if (message.result != 0) {
        ...
        var serverName = this.mLoginSystem.getRecentLoginServerInfo().ServerName;
    ...
    LoginMessageHandler.prototype.onRecvL2C_QUEUE_UPDATE = function (dispatcher, message) {
        this._doQueue(dispatcher, message.position);
    };
    LoginMessageHandler.prototype.onRecvL2C_ROLE_LIST = function (dispatcher, message) {
        ...
        if (message.RoleList.length == 0) {
            ...
            if (message.RoleList.length == 1) {
                ...
                FireEvent(EventDefine.MSG_WAIT_END, null);
                var wnd = WngMrg.getInstance().getWindow("LoginRoleListFrame");
                wnd.showWnd();
            }
        }
    };
    LoginMessageHandler.prototype.onRecvL2C_ROLE_CREATE = function (dispatcher, message) {
        if (message.result != 0) {
    ...
    LoginMessageHandler.prototype.onRecvL2C_ROLE_SELECT = function (dispatcher, message) {
        if (message.result != 0) {
    ...
    LoginMessageHandler.prototype.onRecvSMSG_LOGOUT = function (dispatcher, message) {
        var text = errCode2Text(message.result);
        TLog.Error("LoginMessageHandler.onRecvSMSG_LOGOUT %d %s", message.result, text);
    };
    LoginMessageHandler.prototype.onRecvSMSG_PONG = function (dispatcher, message) {
    };
    LoginMessageHandler.prototype._doQueue = function (dispatcher, pos) {
        if (pos == 0) {
...
__reflect(LoginMessageHandler.prototype, "LoginMessageHandler");
//# sourceMappingURL=LoginMessageHandler.js.map