...
function initInstances() {
    ...
    StaticInstanceMap.forEach(function (name) {
...
function _loadMessage(opDefs, startOp, endOp) {
...
function initMessageDispatches() {
    //登陆连接
    var loginDispatcher = LoginNetDispatcher.getInstance();
    loginDispatcher.addMessageHandle(LoginMessageHandler.newObj());
    //游戏连接
    var gameDispatcher = GameNetDispatcher.getInstance();
...
//# sourceMappingURL=GameStatic.js.map