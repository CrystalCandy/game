...
var dataFieldIndexMap = {};
function bindType(typeName) {
    var dataTypeList = dataTypeMap[typeName];
    //Log.Assert(dataTypeList != null, "objectField bindType Error%s", typeName)
    dataFieldIndexMap = {};
    for (var i = 0; i < dataTypeList.length; i++) {
        var dataType_1 = dataTypeList[i];
        var paramSign = splitString(dataType_1, ":");
        //Log.Assert(paramSign.length == 2)
        var fieldName = paramSign[0];
        dataFieldIndexMap[fieldName] = i;
    }
}
function bind(fieldName) {
    var index = dataFieldIndexMap[fieldName] + 1;
...
objectField.UNIT_FIELD_SPEED = objectField.UNIT_LASTABILITY_BEGIN + 1; //出手速度       33
objectField.UNIT_FIELD_ATTACK = objectField.UNIT_LASTABILITY_BEGIN + 2; //攻击力         34
objectField.UNIT_FIELD_DEFENCE = objectField.UNIT_LASTABILITY_BEGIN + 3; //护甲           35
...
//
objectField.UNIT_FIELD_PER_BEGIN = objectField.UNIT_LASTABILITY_BEGIN + 18; //百分比开始     48
objectField.UNIT_FIELD_HP_PER = objectField.UNIT_LASTABILITY_BEGIN + 18; //生命百分比     48
objectField.UNIT_FIELD_SPEED_PER = objectField.UNIT_LASTABILITY_BEGIN + 19; //速度百分比     48
objectField.UNIT_FIELD_ATT_PER = objectField.UNIT_LASTABILITY_BEGIN + 20; //攻击百分比     49
objectField.UNIT_FIELD_DEF_PER = objectField.UNIT_LASTABILITY_BEGIN + 21; //防御百分比     55
objectField.UNIT_FIELD_HIT_PER = objectField.UNIT_LASTABILITY_BEGIN + 22; //命中百分比     59
objectField.UNIT_FIELD_DODGE_PER = objectField.UNIT_LASTABILITY_BEGIN + 23; //闪避百分比     60
objectField.UNIT_FIELD_CRIT_PER = objectField.UNIT_LASTABILITY_BEGIN + 24; //暴击值百分比   51
objectField.UNIT_FIELD_CRIT_DEC_PER = objectField.UNIT_LASTABILITY_BEGIN + 25; //抗暴值百分比   52
objectField.UNIT_FIELD_DEF_THR_PER = objectField.UNIT_LASTABILITY_BEGIN + 26; //无视防御百分比     53
objectField.UNIT_FIELD_DEF_THR_DEC_PER = objectField.UNIT_LASTABILITY_BEGIN + 27; //减免无视防御百分比   54
...
//
objectField.UNIT_FIELD_HP = objectField.UNIT_LASTABILITY_END + 9; // 当前生命      65
objectField.UNIT_FIELD_MP = objectField.UNIT_LASTABILITY_END + 10; // 当前能量      66
objectField.UNIT_END = objectField.UNIT_LASTABILITY_END + 11; //               67
// //主角 宠物 仙侣 变化的属性//
...
var abilityNameToIndex = {
    maxhp: objectField.UNIT_FIELD_MAX_HP,
    speed: objectField.UNIT_FIELD_SPEED,
    demage: objectField.UNIT_FIELD_ATTACK,
    hujia: objectField.UNIT_FIELD_DEFENCE,
    hitrate: objectField.UNIT_FIELD_HITRATE,
    dodge: objectField.UNIT_FIELD_DODGE,
    critrate: objectField.UNIT_FIELD_CRITICAL,
    critratedec: objectField.UNIT_FIELD_CRITICAL_DEC,
    chuanjia: objectField.UNIT_FIELD_DEF_THR,
    chuanjiadec: objectField.UNIT_FIELD_DEF_THR_DEC,
    attinc: objectField.UNIT_FIELD_ATT_INC,
    attdec: objectField.UNIT_FIELD_ATT_DEC,
    critdamage: objectField.UNIT_FIELD_CRI_ATT,
    critdadec: objectField.UNIT_FIELD_CRI_ATT_DEC,
    pvpattinc: objectField.UNIT_FIELD_PVP_ATT_INC,
    pvpattdec: objectField.UNIT_FIELD_PVP_ATT_DEC,
    pveattinc: objectField.UNIT_FIELD_PVE_ATT_INC,
    pveattdec: objectField.UNIT_FIELD_PVE_ATT_DEC,
    //
    hpPer: objectField.UNIT_FIELD_HP_PER,
    speedPer: objectField.UNIT_FIELD_SPEED_PER,
    attPer: objectField.UNIT_FIELD_ATT_PER,
    hujiaPer: objectField.UNIT_FIELD_DEF_PER,
    hitPer: objectField.UNIT_FIELD_HIT_PER,
    dodgePer: objectField.UNIT_FIELD_DODGE_PER,
    critPer: objectField.UNIT_FIELD_CRIT_PER,
    critdecPer: objectField.UNIT_FIELD_CRIT_DEC_PER,
    chuanjiaPer: objectField.UNIT_FIELD_DEF_THR_PER,
    decchuanjiaPer: objectField.UNIT_FIELD_DEF_THR_DEC_PER,
};
...
function getAbiblityStrEffect(abilityStrTable, isEffect) {
    var effectValue = {};
    var effectPercent = {};
    for (var _ in abilityStrTable) {
        var value = abilityStrTable[_];
        var abilityStr = value[1];
        var abilityValue = value[2];
        var percent = value[3];
        var abilityIndex = abilityNameToIndex[abilityStr];
...
//}
var IndexToabilityName = (_a = {},
    _a[objectField.UNIT_FIELD_MAX_HP] = 'maxhp',
    _a[objectField.UNIT_FIELD_SPEED] = 'speed',
    _a[objectField.UNIT_FIELD_ATTACK] = 'demage',
    _a[objectField.UNIT_FIELD_DEFENCE] = 'hujia',
    _a[objectField.UNIT_FIELD_HITRATE] = 'hitrate',
    _a[objectField.UNIT_FIELD_DODGE] = 'dodge',
    _a[objectField.UNIT_FIELD_CRITICAL] = 'critrate',
    _a[objectField.UNIT_FIELD_CRITICAL_DEC] = 'critratedec',
    _a[objectField.UNIT_FIELD_DEF_THR] = 'chuanjia',
    _a[objectField.UNIT_FIELD_DEF_THR_DEC] = 'chuanjiadec',
    _a[objectField.UNIT_FIELD_ATT_INC] = 'attinc',
    _a[objectField.UNIT_FIELD_ATT_DEC] = 'attdec',
    _a[objectField.UNIT_FIELD_CRI_ATT] = 'critdamage',
    _a[objectField.UNIT_FIELD_CRI_ATT_DEC] = 'critdadec',
    _a[objectField.UNIT_FIELD_PVP_ATT_INC] = 'pvpattinc',
    _a[objectField.UNIT_FIELD_PVP_ATT_DEC] = 'pvpattdec',
    _a[objectField.UNIT_FIELD_PVE_ATT_INC] = 'pveattinc',
    _a[objectField.UNIT_FIELD_PVE_ATT_DEC] = 'pveattdec',
    _a[objectField.UNIT_FIELD_HP_PER] = 'hpPer',
    _a[objectField.UNIT_FIELD_SPEED_PER] = 'speedPer',
    _a[objectField.UNIT_FIELD_ATT_PER] = 'attPer',
    _a[objectField.UNIT_FIELD_DEF_PER] = 'hujiaPer',
    _a[objectField.UNIT_FIELD_HIT_PER] = 'hitPer',
    _a[objectField.UNIT_FIELD_DODGE_PER] = 'dodgePer',
    _a[objectField.UNIT_FIELD_CRIT_PER] = 'critPer',
    _a[objectField.UNIT_FIELD_CRIT_DEC_PER] = 'critdecPer',
    _a[objectField.UNIT_FIELD_DEF_THR_PER] = 'chuanjiaPer',
    _a[objectField.UNIT_FIELD_DEF_THR_DEC_PER] = 'decchuanjiaPer',
    _a);
//
////装备类型对应宠物属性
...
//}
//二级属性
var lastAbilityNameToIdOptions = {
    maxhp: objectField.UNIT_FIELD_MAX_HP,
    speed: objectField.UNIT_FIELD_SPEED,
    demage: objectField.UNIT_FIELD_ATTACK,
    hujia: objectField.UNIT_FIELD_DEFENCE,
