...
var ItemBeiBaoFrame = (function (_super) {
    __extends(ItemBeiBaoFrame, _super);
    function ItemBeiBaoFrame() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    ItemBeiBaoFrame.prototype.initObj = function () {
        var params = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            params[_i] = arguments[_i];
        }
        this.mLayoutPaths = ["layouts/item/ItemBeibaoLayout.exml"];
        this.tabIndex = -1;
        //this.equipTabIndex = 1
        //this.resetList = true;
    };
    ItemBeiBaoFrame.prototype.onLoad = function () {
        ...
        var elemInfo = [
            ...
            (_c = {}, _c["name"] = "label_wndName", _c["title"] = "", _c["event_name"] = egret.TouchEvent.TOUCH_TAP, _c["fun_index"] = null, _c),
        ];
...
*/
    ...
    ItemBeiBaoFrame.prototype.onUnLoad = function () {
    };
    ItemBeiBaoFrame.prototype.onShow = function () {
    ...
    ItemBeiBaoFrame.prototype.onHide = function () {
        //UnRegisterEvent(EventDefine.ITEM_UPDATE, this.refreshFrame, this)
        this.mLayoutNode.visible = false;
        this.tabWndList.setWndVisible(false);
        this.mLayoutNode.setDoModal(false);
    };
    ItemBeiBaoFrame.prototype.showWithIndex = function (index) {
        this.tabIndex = index;
        this.showWnd();
    };
    return ItemBeiBaoFrame;
}(BaseWnd));
__reflect(ItemBeiBaoFrame.prototype, "ItemBeiBaoFrame");
/*
    refreshFrame() {
...
module itemRender {
    export class BeibaoItem extends eui.ItemRenderer {
        ...
        constructor() {
            ...
            this.skinName = "layouts/itemRender/BeibaoItemLayout.exml"
        }
    ...
    export class BeibaoEquipItem extends eui.ItemRenderer {
        ...
        constructor() {
            ...
            this.addEventListener(egret.Event.COMPLETE, this.onComplete, this);
            this.skinName = "layouts/itemRender/BeibaoEquipItemLayout.exml"
        }
...
*/ 
//# sourceMappingURL=ItemBeiBaoFrame.js.map