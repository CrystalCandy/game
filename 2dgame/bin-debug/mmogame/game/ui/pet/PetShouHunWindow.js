...
var PetShouHunWindow = (function (_super) {
    __extends(PetShouHunWindow, _super);
    function PetShouHunWindow() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    PetShouHunWindow.prototype.initObj = function () {
        var params = [];
    ...
    PetShouHunWindow.prototype.onLoad = function () {
    ...
    PetShouHunWindow.prototype.onUnLoad = function () {
        if (this.Player) {
    ...
    PetShouHunWindow.prototype.onShow = function () {
    ...
    PetShouHunWindow.prototype.onHide = function () {
    ...
    PetShouHunWindow.prototype.initShouHunWnd = function () {
    ...
    PetShouHunWindow.prototype.refreshFrame = function () {
        var soulInfo = {};
    ...
    PetShouHunWindow.prototype.refreshActorWnd = function () {
        //更新名字
    ...
    PetShouHunWindow.prototype.updateRefreshState = function (name, stage) {
    ...
    ////////////////////////////////////响应事件//////////////////////////////////
    PetShouHunWindow.prototype.onClickRefreshBtn = function (event) {
    ...
    //幻化
    PetShouHunWindow.prototype.onClickTurn = function (event) {
        if (this.mParentWnd.tabWndList.getTabIndex() == 3) {
            FunUITools.sendTurnRequest(this.soulType, this.select);
        }
    };
    //升阶
    PetShouHunWindow.prototype.onClickUpgrade = function (event) {
        if (this.mParentWnd.tabWndList.getTabIndex() == 3) {
            FunUITools.upgradeFunction(this.soulType, this);
        }
    };
    //自动升阶
    PetShouHunWindow.prototype.onClickAutoUpgrade = function (event) {
        if (this.mParentWnd.tabWndList.getTabIndex() == 3) {
            FunUITools.upgradeAutoFunction(this.soulType, this, "btn_auto_upgrade", "btn_upgrade");
        }
    };
    //属性丹
    PetShouHunWindow.prototype.onClickProperty = function (event) {
        if (this.mParentWnd.tabWndList.getTabIndex() == 3) {
            FunUITools.openPropertyFrame(this.soulType);
        }
    };
    //换装
    PetShouHunWindow.prototype.onClickWearEquip = function (event) {
        if (this.mParentWnd.tabWndList.getTabIndex() == 3) {
            FunUITools.oneKeyWearEquip(this.soulType, this, this.equipList);
        }
    };
    return PetShouHunWindow;
}(BaseCtrlWnd));
__reflect(PetShouHunWindow.prototype, "PetShouHunWindow");
//# sourceMappingURL=PetShouHunWindow.js.map