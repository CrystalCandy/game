...
var TianXian_GoddessWnd = (function (_super) {
    __extends(TianXian_GoddessWnd, _super);
    function TianXian_GoddessWnd() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    TianXian_GoddessWnd.prototype.initObj = function () {
        var params = [];
    ...
    TianXian_GoddessWnd.prototype.onLoad = function () {
    ...
    TianXian_GoddessWnd.prototype.onUnLoad = function () {
        if (this.Player) {
    ...
    TianXian_GoddessWnd.prototype.onShow = function () {
    ...
    TianXian_GoddessWnd.prototype.onHide = function () {
    ...
    TianXian_GoddessWnd.prototype.onRefresh = function () {
    ...
    TianXian_GoddessWnd.prototype.onRefreshTop = function () {
        if (this.select == 0) {
            this.select = 1;
        }
        var arr = this.list;
    ...
    TianXian_GoddessWnd.prototype.onInitItemBox = function () {
        FunUITools.updateEquipWnd(this.type, this);
        //更新技能 
        FunUITools.updateSkillWnd(this.type, this);
    };
    TianXian_GoddessWnd.prototype.onUnrealClick = function () {
    ...
    TianXian_GoddessWnd.prototype.onRightClick = function () {
        if (this.mParentWnd.tabWndList.getTabIndex() == 0) {
    ...
    TianXian_GoddessWnd.prototype.onLeftClick = function () {
        if (this.mParentWnd.tabWndList.getTabIndex() == 0) {
    ...
    TianXian_GoddessWnd.prototype.onPropertyClick = function () {
        if (this.mParentWnd.tabWndList.getTabIndex() == 0) {
            FunUITools.openPropertyFrame(this.type);
        }
    };
    TianXian_GoddessWnd.prototype.onSkinClick = function () {
        if (this.mParentWnd.tabWndList.getTabIndex() == 0) {
            FunUITools.openSkinsFrame(this.type);
        }
    };
    TianXian_GoddessWnd.prototype.onSearchClick = function () {
        if (this.mParentWnd.tabWndList.getTabIndex() == 0) {
            FunUITools.openFunPropertyFrame(this.type, this.select);
        }
    };
    TianXian_GoddessWnd.prototype.onUpClick = function () {
        if (this.mParentWnd.tabWndList.getTabIndex() == 0) {
            FunUITools.upgradeFunction(this.type, this);
        }
    };
    TianXian_GoddessWnd.prototype.onAutoUpClick = function () {
        if (this.mParentWnd.tabWndList.getTabIndex() == 0) {
            FunUITools.upgradeAutoFunction(this.type, this, "btn_auto_upgrade", "btn_upgrade");
        }
    };
    TianXian_GoddessWnd.prototype.onEquipClick = function () {
        if (this.mParentWnd.tabWndList.getTabIndex() == 0) {
            var templist = FunUITools.checkWearEquip(this.type, this);
            FunUITools.oneKeyWearEquip(this.type, this, templist);
        }
    };
    return TianXian_GoddessWnd;
}(BaseCtrlWnd));
__reflect(TianXian_GoddessWnd.prototype, "TianXian_GoddessWnd");
//# sourceMappingURL=TianXian_GoddessWnd.js.map