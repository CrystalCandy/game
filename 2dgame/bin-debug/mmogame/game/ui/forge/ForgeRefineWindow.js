...
var ForgeRefineWindow = (function (_super) {
    __extends(ForgeRefineWindow, _super);
    function ForgeRefineWindow() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    ForgeRefineWindow.prototype.initObj = function () {
        var params = [];
    ...
    ForgeRefineWindow.prototype.onLoad = function () {
    ...
    ForgeRefineWindow.prototype.onUnLoad = function () {
    };
    ForgeRefineWindow.prototype.onShow = function () {
        ...
        var str = String.format(Localize_cns("FORGE_BTN"), Localize_cns("FORGE_TXT2"));
        this.mElemList["btn_oneKey"].text = str;
        this.onInit();
        this.onRefresh();
    };
    ForgeRefineWindow.prototype.onHide = function () {
    ...
    ForgeRefineWindow.prototype.onInit = function () {
    ...
    ForgeRefineWindow.prototype.onRefresh = function () {
        ///刷新大师
    ...
    ForgeRefineWindow.prototype.onInitForce = function () {
    ...
    ForgeRefineWindow.prototype.onTimer = function () {
        for (var i = 1; i <= 10; i++) {
            this.mElemList["equipItem_select" + i].visible = false;
        }
        this.select += 1;
    ...
    ForgeRefineWindow.prototype.onRefreshDes = function () {
        var endIndex = 11;
        var isEnd = false;
    ...
    ForgeRefineWindow.prototype.refreshForceNum = function (force) {
        DrawNumberStringImage(this.mElemList["bImage"], "zhanLi_", "z" + force, 0, 0, -3);
    };
    //////响应事件
    ForgeRefineWindow.prototype.onOneKeyClick = function () {
        if (this.timer != null)
            return;
        var index = this.mParentWnd.tabWndList.getTabIndex();
        if (index == 1) {
    ...
    return ForgeRefineWindow;
}(BaseCtrlWnd));
__reflect(ForgeRefineWindow.prototype, "ForgeRefineWindow");
//# sourceMappingURL=ForgeRefineWindow.js.map