...
var ForgeBaoShiWindow = (function (_super) {
    __extends(ForgeBaoShiWindow, _super);
    function ForgeBaoShiWindow() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    ForgeBaoShiWindow.prototype.initObj = function () {
        var params = [];
    ...
    ForgeBaoShiWindow.prototype.onLoad = function () {
    ...
    ForgeBaoShiWindow.prototype.onUnLoad = function () {
    };
    ForgeBaoShiWindow.prototype.onShow = function () {
        ...
        var str = String.format(Localize_cns("FORGE_BTN"), Localize_cns("FORGE_XIANGQIAN"));
        this.mElemList["btn_oneKey"].text = str;
        this.onInit();
        this.onRefresh();
    };
    ForgeBaoShiWindow.prototype.onHide = function () {
    ...
    ForgeBaoShiWindow.prototype.onInit = function () {
    ...
    ForgeBaoShiWindow.prototype.onRefresh = function () {
        ///刷新大师
    ...
    ForgeBaoShiWindow.prototype.onInitForce = function (List) {
    ...
    ForgeBaoShiWindow.prototype.onTimer = function () {
        for (var i = 1; i <= 10; i++) {
            this.mElemList["equipItem_select" + i].visible = false;
        }
        this.select += 1;
    ...
    ForgeBaoShiWindow.prototype.onRefreshDes = function () {
        var endIndex = 11;
        var isEnd = false;
        ...
        var force = GetForceMath(nowConfig);
        var baoshiStr = ForgeSystem.getInstance().getBaoShiStr(this.type, this.select - 1, level);
    ...
    ForgeBaoShiWindow.prototype.refreshForceNum = function (force) {
        DrawNumberStringImage(this.mElemList["bImage"], "zhanLi_", "z" + force, 0, 0, -3);
    };
    //////响应事件
    ForgeBaoShiWindow.prototype.onOneKeyClick = function () {
        if (this.timer != null)
            return;
        var index = this.mParentWnd.tabWndList.getTabIndex();
        if (index == 3) {
    ...
    return ForgeBaoShiWindow;
}(BaseCtrlWnd));
__reflect(ForgeBaoShiWindow.prototype, "ForgeBaoShiWindow");
//# sourceMappingURL=ForgeBaoShiWindow.js.map