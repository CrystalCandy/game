...
var XianLvZhenFaWindow = (function (_super) {
    __extends(XianLvZhenFaWindow, _super);
    function XianLvZhenFaWindow() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    XianLvZhenFaWindow.prototype.initObj = function () {
        var params = [];
    ...
    XianLvZhenFaWindow.prototype.onLoad = function () {
    ...
    XianLvZhenFaWindow.prototype.onUnLoad = function () {
        if (this.Player) {
    ...
    XianLvZhenFaWindow.prototype.onShow = function () {
    ...
    XianLvZhenFaWindow.prototype.onHide = function () {
    ...
    XianLvZhenFaWindow.prototype.onRefresh = function () {
    ...
    XianLvZhenFaWindow.prototype.onRefreshTop = function () {
        if (this.select == 0) {
            this.select = 1;
        }
        var arr = this.list;
    ...
    XianLvZhenFaWindow.prototype.onInitItemBox = function () {
        FunUITools.updateEquipWnd(this.type, this);
        //更新技能 
        FunUITools.updateSkillWnd(this.type, this);
    };
    XianLvZhenFaWindow.prototype.onUnrealClick = function () {
    ...
    XianLvZhenFaWindow.prototype.onRightClick = function () {
        if (this.mParentWnd.tabWndList.getTabIndex() == 1) {
    ...
    XianLvZhenFaWindow.prototype.onLeftClick = function () {
        if (this.mParentWnd.tabWndList.getTabIndex() == 1) {
    ...
    XianLvZhenFaWindow.prototype.onPropertyClick = function () {
        if (this.mParentWnd.tabWndList.getTabIndex() == 1) {
            FunUITools.openPropertyFrame(this.type);
        }
    };
    XianLvZhenFaWindow.prototype.onSearchClick = function () {
        if (this.mParentWnd.tabWndList.getTabIndex() == 1) {
            FunUITools.openFunPropertyFrame(this.type, this.select);
        }
    };
    XianLvZhenFaWindow.prototype.onUpClick = function () {
        if (this.mParentWnd.tabWndList.getTabIndex() == 1) {
            FunUITools.upgradeFunction(this.type, this);
        }
    };
    XianLvZhenFaWindow.prototype.onAutoUpClick = function () {
        if (this.mParentWnd.tabWndList.getTabIndex() == 1) {
            FunUITools.upgradeAutoFunction(this.type, this, "btn_auto_upgrade", "btn_upgrade");
        }
    };
    XianLvZhenFaWindow.prototype.onEquipClick = function () {
        if (this.mParentWnd.tabWndList.getTabIndex() == 1) {
            var templist = FunUITools.checkWearEquip(this.type, this);
            FunUITools.oneKeyWearEquip(this.type, this, templist);
        }
    };
    return XianLvZhenFaWindow;
}(BaseCtrlWnd));
__reflect(XianLvZhenFaWindow.prototype, "XianLvZhenFaWindow");
//# sourceMappingURL=XianLvZhenFaWindow.js.map