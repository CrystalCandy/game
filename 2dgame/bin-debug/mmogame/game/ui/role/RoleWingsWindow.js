...
var RoleWingsWindow = (function (_super) {
    __extends(RoleWingsWindow, _super);
    function RoleWingsWindow() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    RoleWingsWindow.prototype.initObj = function () {
        var params = [];
    ...
    RoleWingsWindow.prototype.onLoad = function () {
    ...
    RoleWingsWindow.prototype.onUnLoad = function () {
        if (this.Player) {
    ...
    RoleWingsWindow.prototype.onShow = function () {
    ...
    RoleWingsWindow.prototype.onHide = function () {
    ...
    RoleWingsWindow.prototype.onRefresh = function () {
    ...
    RoleWingsWindow.prototype.onRefreshTop = function () {
        if (this.select == 0) {
            this.select = 1;
        }
        var arr = this.list;
    ...
    RoleWingsWindow.prototype.onRightClick = function () {
        if (this.mParentWnd.tabWndList.getTabIndex() == 3) {
    ...
    RoleWingsWindow.prototype.onLeftClick = function () {
        if (this.mParentWnd.tabWndList.getTabIndex() == 3) {
    ...
    RoleWingsWindow.prototype.onPropertyClick = function () {
        if (this.mParentWnd.tabWndList.getTabIndex() == 3) {
            FunUITools.openPropertyFrame(this.type);
        }
    };
    RoleWingsWindow.prototype.onUpClick = function () {
        if (this.mParentWnd.tabWndList.getTabIndex() == 3) {
            FunUITools.upgradeFunction(this.type, this);
        }
    };
    RoleWingsWindow.prototype.onAutoUpClick = function () {
        if (this.mParentWnd.tabWndList.getTabIndex() == 3) {
            FunUITools.upgradeAutoFunction(this.type, this, "btn_auto_upgrade", "btn_upgrade");
        }
    };
    RoleWingsWindow.prototype.onEquipClick = function () {
        if (this.mParentWnd.tabWndList.getTabIndex() == 3) {
            var equiplist = FunUITools.checkWearEquip(this.type, this);
            if (size_t(equiplist) == 0)
                return;
    ...
    return RoleWingsWindow;
}(BaseCtrlWnd));
__reflect(RoleWingsWindow.prototype, "RoleWingsWindow");
//# sourceMappingURL=RoleWingsWindow.js.map