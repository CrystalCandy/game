...
var TianNvHuaNianWindow = (function (_super) {
    __extends(TianNvHuaNianWindow, _super);
    function TianNvHuaNianWindow() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    TianNvHuaNianWindow.prototype.initObj = function () {
        var params = [];
    ...
    TianNvHuaNianWindow.prototype.onLoad = function () {
    ...
    TianNvHuaNianWindow.prototype.onUnLoad = function () {
        if (this.Player) {
    ...
    TianNvHuaNianWindow.prototype.onShow = function () {
    ...
    TianNvHuaNianWindow.prototype.onHide = function () {
    ...
    TianNvHuaNianWindow.prototype.onRefresh = function () {
        ...
        var name = cellOptionsName[this.type - 1];
    ...
    TianNvHuaNianWindow.prototype.onRefreshTop = function () {
        if (this.select == 0) {
            this.select = 1;
        }
        var arr = this.list;
    ...
    TianNvHuaNianWindow.prototype.onInitItemBox = function () {
    ...
    TianNvHuaNianWindow.prototype.onShowFunFrame = function (list) {
        var typelist = [
            cellOptionsIndex.TianNv,
            cellOptionsIndex.TianNvXianQi,
            cellOptionsIndex.TianNvHuaNian,
    ...
    TianNvHuaNianWindow.prototype.onUnrealClick = function () {
    ...
    TianNvHuaNianWindow.prototype.onRightClick = function () {
        if (this.mParentWnd.tabWndList.getTabIndex() == 2) {
    ...
    TianNvHuaNianWindow.prototype.onLeftClick = function () {
        if (this.mParentWnd.tabWndList.getTabIndex() == 2) {
    ...
    TianNvHuaNianWindow.prototype.onPropertyClick = function () {
        if (this.mParentWnd.tabWndList.getTabIndex() == 2) {
            FunUITools.openPropertyFrame(this.type);
        }
    };
    TianNvHuaNianWindow.prototype.onUpClick = function () {
        if (this.mParentWnd.tabWndList.getTabIndex() == 2) {
            FunUITools.upgradeFunction(this.type, this);
        }
    };
    TianNvHuaNianWindow.prototype.onAutoUpClick = function () {
        if (this.mParentWnd.tabWndList.getTabIndex() == 2) {
            FunUITools.upgradeAutoFunction(this.type, this, "btn_auto_upgrade", "btn_upgrade");
        }
    };
    TianNvHuaNianWindow.prototype.onEquipClick = function () {
        if (this.mParentWnd.tabWndList.getTabIndex() == 2) {
            var templist = FunUITools.checkWearEquip(this.type, this);
            FunUITools.oneKeyWearEquip(this.type, this, templist);
        }
    };
    TianNvHuaNianWindow.prototype.onSearchClick = function () {
        if (this.mParentWnd.tabWndList.getTabIndex() == 2) {
            FunUITools.openFunPropertyFrame(this.type, this.select);
        }
    };
    return TianNvHuaNianWindow;
}(BaseCtrlWnd));
__reflect(TianNvHuaNianWindow.prototype, "TianNvHuaNianWindow");
//# sourceMappingURL=TianNvHuaNianWindow.js.map