...
var TianNvLingQiWindow = (function (_super) {
    __extends(TianNvLingQiWindow, _super);
    function TianNvLingQiWindow() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    TianNvLingQiWindow.prototype.initObj = function () {
        var params = [];
    ...
    TianNvLingQiWindow.prototype.onLoad = function () {
    ...
    TianNvLingQiWindow.prototype.onUnLoad = function () {
        if (this.Player) {
    ...
    TianNvLingQiWindow.prototype.onShow = function () {
    ...
    TianNvLingQiWindow.prototype.onHide = function () {
    ...
    TianNvLingQiWindow.prototype.onRefresh = function () {
    ...
    TianNvLingQiWindow.prototype.onRefreshTop = function () {
        if (this.select == 0) {
            this.select = 1;
        }
        var arr = this.list;
    ...
    TianNvLingQiWindow.prototype.onInitItemBox = function () {
    ...
    TianNvLingQiWindow.prototype.onShowFunFrame = function (list) {
        var typelist = [
            cellOptionsIndex.TianNv,
            cellOptionsIndex.TianNvXianQi,
            cellOptionsIndex.TianNvHuaNian,
    ...
    TianNvLingQiWindow.prototype.onUnrealClick = function () {
    ...
    TianNvLingQiWindow.prototype.onRightClick = function () {
        if (this.mParentWnd.tabWndList.getTabIndex() == 3) {
    ...
    TianNvLingQiWindow.prototype.onLeftClick = function () {
        if (this.mParentWnd.tabWndList.getTabIndex() == 3) {
    ...
    TianNvLingQiWindow.prototype.onPropertyClick = function () {
        if (this.mParentWnd.tabWndList.getTabIndex() == 3) {
            FunUITools.openPropertyFrame(this.type);
        }
    };
    TianNvLingQiWindow.prototype.onUpClick = function () {
        if (this.mParentWnd.tabWndList.getTabIndex() == 3) {
            FunUITools.upgradeFunction(this.type, this);
        }
    };
    TianNvLingQiWindow.prototype.onAutoUpClick = function () {
        if (this.mParentWnd.tabWndList.getTabIndex() == 3) {
            FunUITools.upgradeAutoFunction(this.type, this, "btn_auto_upgrade", "btn_upgrade");
        }
    };
    TianNvLingQiWindow.prototype.onEquipClick = function () {
        if (this.mParentWnd.tabWndList.getTabIndex() == 3) {
            var templist = FunUITools.checkWearEquip(this.type, this);
            FunUITools.oneKeyWearEquip(this.type, this, templist);
        }
    };
    TianNvLingQiWindow.prototype.onSearchClick = function () {
        if (this.mParentWnd.tabWndList.getTabIndex() == 3) {
            FunUITools.openFunPropertyFrame(this.type, this.select);
        }
    };
    return TianNvLingQiWindow;
}(BaseCtrlWnd));
__reflect(TianNvLingQiWindow.prototype, "TianNvLingQiWindow");
//# sourceMappingURL=TianNvLingQiWindow.js.map