...
let taskFinishId: any = {
	...
	CAMPAIGN_NUM 		: taskFinishIdBegin + 10,//通过多少关关卡　接到任务后统计数量
	...
	COPY_MATERIAL_COUNT			: taskFinishIdBegin + 61,		//材料副本，完成指定副本索引
	COPY_MATERIAL_NUM			: taskFinishIdBegin + 62,		//材料副本打多少次　接到任务后统计数量
	COPY_ZHONGKUI_COUNT			: taskFinishIdBegin + 63,		//钟馗伏魔今日战斗次数
	COPY_ZHONGKUI_NUM			: taskFinishIdBegin + 64,		//钟馗伏魔打多少次　接到任务后统计数量	
	COPY_THUNDER_MAX			: taskFinishIdBegin + 65,		//小雷音寺最高通关层数
	COPY_THUNDER_NUM			: taskFinishIdBegin + 66,		//小雷音寺打多少次　接到任务后统计数量
	COPY_TEAM_COMBAT_NUM		: taskFinishIdBegin + 67,		//跨服组队，完成条件：组队进入副本次数达到指定次数完成条件
	CHAMPION_NUM				: taskFinishIdBegin + 68,		//竞技场擂台比武，完成条件：当天累计比武次数达到指定次数完成任务；
}
