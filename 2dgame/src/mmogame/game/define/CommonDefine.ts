...
let OrdinaryActivityName:any = {
	// [OrdinaryActivityIndex.SKYTOWER]								: "ACTIVITY_NAME1",				//试练场
	// [OrdinaryActivityIndex.SHENGDI]									: "ACTIVITY_NAME2",				//圣地
	// [OrdinaryActivityIndex.CAMPAIGN]								: "MAIN_TXT23",						//关卡
	// [OrdinaryActivityIndex.JUNCHUANZHAN]						: "ACTIVITY_TXT56",				//公会战
	// [OrdinaryActivityIndex.ZHENYING]								: "GODSWAR_TEXT",					//众神之战
	// [OrdinaryActivityIndex.FENGMO]									: "ACTIVITY_NAME4",				//封魔
	// [OrdinaryActivityIndex.ROBBER_BOSS]							: "ACTIVITY_NAME5",				//圣地boss
}
...
let ItemUnitName:any = {
	...
	[opItemUnit.JJC_POINT]										: "JJC_TXT43",					//竞技积分
