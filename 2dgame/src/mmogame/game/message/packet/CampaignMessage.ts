...
class Message_G2C_FIGHT_ENTER_CAMPAIGN extends MessageBase {
	campaignId: number;
...
class Message_C2G_FIGHT_CAMPAIGN extends MessageBase {
	index: number;
	public initObj(...args: any[]): void {
		this.index = 0
	}
...
class Message_C2G_FIGHT_BATTLE_QUEUE extends MessageBase {
...
class Message_C2G_FIGHT_GET_BATTLE_QUEUE extends MessageBase {
	queueType: number;
	public initObj(...args: any[]): void {
		this.queueType = 0
	}
...
class Message_G2C_FIGHT_GET_BATTLE_QUEUE extends MessageBase {
	queueType: number;
	queue: any;
...
class Message_G2C_FIGHT_WIN extends MessageBase {
	fightType
	commonPrize
...
class Message_G2C_FIGHT_CAMPAIGN_RECORD extends MessageBase {
...
class Message_G2C_FIGHT_LOST extends MessageBase {
	fightType
	commonList
	relicFightInfo
	public initObj(...args: any[]): void {
...
class Message_C2G_FIGHT_SYNC_SHOWEND extends MessageBase {
	count
	fighterHPList
	public initObj(...args: any[]): void {
		this.count = 0
...
class Message_C2G_CHAMPION_WEAP extends MessageBase {
	campaignId
	weapCount
	public initObj(...args: any[]): void {
...
class Message_G2C_CHAMPION_WEAP extends MessageBase {
	campaignId
	commonList
	fightType
	public initObj(...args: any[]): void {
...
class Message_C2G_EXCITE_SERVER_FIRST_CAMPAIGN extends MessageBase {
	campaignId
	public initObj(...args: any[]): void {
		this.campaignId = 0
	}
...
class Message_G2C_EXCITE_SERVER_FIRST_CAMPAIGN extends MessageBase {
...
class Message_G2C_EXCITE_TIPS extends MessageBase {
	awardType
	public initObj(...args: any[]): void {
		this.awardType = ""
	}
...
//返回替补阵容
class Message_G2C_FIGHT_RESERVE_LINE_UP extends MessageBase {
	arrayType
	altemate
	public initObj(...args: any[]): void {
		this.arrayType = 0
...
//设置替补阵容
class Message_C2G_FIGHT_RESERVE_LINE_UP extends MessageBase {
	arrayType
	altemate
	public initObj(...args: any[]): void {
		this.arrayType = 0
...
class Message_C2G_FIGHT_LINE_UP_INFO extends MessageBase {
	arrayType
	public initObj(...args: any[]): void {
		this.arrayType = 0
	}
...
class Message_G2C_FIGHT_LINE_UP_DATA extends MessageBase {
	altemateList
	public initObj(...args: any[]): void {
		this.altemateList = {}
	}
...
//组队关卡
//进入关卡
class Message_C2G_FIGHT_ENTER_CAMPAIGN_INFO extends MessageBase {
...
class Message_G2C_FIGHT_ENTER_CAMPAIGN_INFO extends MessageBase {
	campaignId
	curCampaignId
	public initObj(...args: any[]): void {
...
//设置当前打的关卡(队长操作)
class Message_C2G_FIGHT_SET_CAMPAIGN extends MessageBase {
	campaignId
	public initObj(...args: any[]): void {
		this.campaignId = 0
	}
...
class Message_G2C_EXCITE_LIMIT_CAMPAIGN extends MessageBase {
	campaignIndex
	campaignRemainTime
	campaignDeadLine
	public initObj(...args: any[]): void {
...
//全服首通
class Message_C2G_EXCITE_NOT_SERVER_FIRST_CAMP extends MessageBase {
	public initObj(...args: any[]): void {
...
//全服首通
class Message_G2C_EXCITE_NOT_SERVER_FIRST_CAMP extends MessageBase {
	campaignId
	public initObj(...args: any[]): void {
		this.campaignId = 0
	}
...
//功能礼包
class Message_C2G_ITEM_CAMPAGIN_GIFT_BUY extends MessageBase {
	index
	public initObj(...args: any[]): void {
		this.index = 0
	}
