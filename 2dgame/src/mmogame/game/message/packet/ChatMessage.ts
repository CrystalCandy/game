//////////////////////////////////////////////////////////////////-
//发送聊天
class Message_C2G_CHANNEL_SEND extends MessageBase {
	channel
	data
	name
	groupId
...
class ChannelMsgPacket extends RoleInfo {
...
class Message_G2C_CHANNEL_SEND extends MessageBase {
...
//设置聊天气泡
class Message_C2G_CHANNEL_WINDOW_TYPE extends MessageBase{
	chatBubbleType
public initObj(...args:any[]):void {
...
//已解锁聊天气泡
class Message_G2C_ROLE_CHAT_WINDOW_LIST extends MessageBase{
	chatBubbleList
public initObj(...args:any[]):void {
	this.chatBubbleList = {}
}
...
//申请查看玩家信息
class Message_C2G_CHANNEL_PLAYER extends MessageBase {
	playerId
	public initObj(...args: any[]): void {
		this.playerId = 0
	}
...
class Message_G2C_CHANNEL_PLAYER extends MessageBase {
	playerInfo
	public initObj(...args: any[]): void {
		this.playerInfo = {}
	}
...
class Message_C2G_CHANNEL_PET_ITEM extends MessageBase {
	playerId
	rage
	uId
...
// 	//语音////////////////////////-
class Message_C2G_CHANNEL_VOICE extends MessageBase {
	channel
	roleId
	recordBuffer
	recordSize
...
class Message_G2C_CHANNEL_VOICE extends MessageBase {
	id
	name
	body
	VipLevel
...
class Message_G2C_CHANNEL_VOICE_UID extends MessageBase {
	id
	name
	body
	VipLevel
...
class Message_C2G_CHANNEL_GET_VOICE extends MessageBase {
	channel
	voiceID
	public initObj(...args: any[]): void {
		this.channel = null
...
class Message_G2C_CHANNEL_GET_VOICE extends MessageBase {
	channel
	voiceID
	size
	buff
...
class Message_G2C_QIANGDA_QUESTION extends MessageBase {
	questionIndex
	public initObj(...args: any[]): void {
...
class Message_C2G_CHANNEL_RECARD_SEND extends MessageBase {
	channelId
	public initObj(...args: any[]): void {
		this.channelId = 0
	}
...
class Message_G2C_CHANNEL_RECARD_SEND extends MessageBase {
	recordList: any[];
	sexId
	public initObj(...args: any[]): void {
		this.recordList = []
