...
//请求竞技场信息
class Message_C2G_FIGHT_CHAMPION_REFRESH extends MessageBase {
...
//竞技场信息
class Message_G2C_FIGHT_CHAMPION_REFRESH extends MessageBase {
    force:number
    rank:number
    times:number
    maxTimes:number
...
//排名
class Message_C2G_FIGHT_CHAMPION_TOP_RANK extends MessageBase {
...
//排名
class Message_G2C_FIGHT_CHAMPION_TOP_RANK extends MessageBase {
    enemyList:any[]
...
class Message_C2G_FIGHT_CHAMPION_BATTLE extends MessageBase {
    rank:number
    name:string
    playerID:number
...
class Message_C2G_FIGHT_CHAMPION_RECORD extends MessageBase {
    public initObj(...args: any[]): void {
...
class Message_G2C_FIGHT_CHAMPION_RECORD extends MessageBase {
...
//观看录像
class Message_C2G_FIGHT_CHAMPION_VIEDO extends MessageBase {
    viedoID:number
    roleId:number
...
//观看全局录像
class Message_C2G_FIGHT_GLOBAL_VIEDO extends MessageBase {
    viedoID:number
    roleId:number
...
//清除等待时间
class Message_C2G_FIGHT_CHAMPION_CLEAR extends MessageBase {
    public initObj(...args: any[]): void {
...
//竞技场刷新
class Message_C2G_FIGHT_CHAMPION_REFRESH_EX extends MessageBase{
public initObj(...args:any[]):void {
...
//竞技场刷新返回
class Message_G2C_FIGHT_CHAMPION_REFRESH_EX extends MessageBase {
    times:number
    maxTimes:number
    time:number
    winStreak:number
...
class Message_G2C_FIGHT_CHAMPION_EX_PRIZE extends MessageBase {
    bestRank:number
    plrRank:number
    rankUp:number
...
class Message_C2G_FIGHT_CHAMPION_INCREASE extends MessageBase {
    buyTime:number
