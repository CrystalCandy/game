...
//战斗开始
class Message_G2C_FIGHT_BEGIN extends MessageBase {
	fightType
	campainId
	fightSide
...
class Message_G2C_FIGHT_ESOTERIC_POWER extends MessageBase {
	mp
	public initObj(...args: any[]): void {
		this.mp = 0
	}
...
class Message_G2C_FIGHT_ADD extends MessageBase {
	fighterList: any[]
	public initObj(...args: any[]): void {
...
class Message_G2C_FIGHT_BOUT extends MessageBase {
	bout
	public initObj(...args: any[]): void {
		this.bout = 0
	}
...
class Message_G2C_FIGHT_END extends MessageBase {
	public initObj(...args: any[]): void {
...
class Message_G2C_FIGHT_RESULT extends MessageBase {
	resultList: any[]
	video:boolean;
	public initObj(...args: any[]): void {
...
//战斗出手队列
class Message_G2C_FIGHT_SEQUENCE extends MessageBase {
	list: any[]
	public initObj(...args: any[]): void {
		this.list = []
		this.isdump = false;
...
//战斗重连
class Message_G2C_FIGHT_REBEGIN extends MessageBase {
	fightType
	compaignId
	fightSide
	mpPoint
...
//发送战斗指令
class Message_C2G_FIGHT_CMD extends MessageBase {
	fightId
	skillType
	public initObj(...args: any[]): void {
		this.fightId = 0
...
//完成所有播放
class Message_C2G_FIGHT_DRAWDONE extends MessageBase {
	public initObj(...args: any[]): void {
		//this.bout = 0 
	}
...
class Message_C2G_FIGHT_ESCAPE extends MessageBase {
	bout
	index
	public initObj(...args: any[]): void {
		this.bout = 0
...
class Message_C2G_ROLE_TEAM_COMBAT extends MessageBase {
	fight_id
	public initObj(...args: any[]): void {
		this.fight_id = 0
	}
...
class Message_G2C_FIGHT_READY extends MessageBase {
	id
	public initObj(...args: any[]): void {
		this.id = 0
	}
...
// 申请获取通缉犯列表
class Message_C2G_GET_WANTED_LIST extends MessageBase {
	index
	public initObj(...args: any[]): void {
		this.index = 0
	}
...
class Message_G2C_GET_WANTED_LIST extends MessageBase {
	count
	playerList: any[]
	public initObj(...args: any[]): void {
		this.count = 0
...
class Message_C2G_FETCH_WANTED_TOKEN extends MessageBase {
	id
	public initObj(...args: any[]): void {
		this.id = 0
	}
...
class Message_C2G_MAP_NPC_COMBAT extends MessageBase {
	id
	public initObj(...args: any[]): void {
		this.id = 0
	}
...
class Message_C2G_FIGHT_ENTER_CAMPAIGN extends MessageBase {
	index
	public initObj(...args: any[]): void {
		this.index = 0
	}
...
class Message_C2G_FIGHT_RESTART extends MessageBase {
	public initObj(...args: any[]): void {
...
//战斗录像
class Message_G2C_FIGHT_VIEDO extends MessageBase {
	message_fight_begin
	message_fighter_add
	pageCount
	public initObj(...args: any[]): void {
...
// 录像分页
class Message_G2C_FIGHT_VIEDO_PAGE extends MessageBase {
...
class Message_C2G_FIGHT_SYNC_TICKTIME extends MessageBase {
	public initObj(...args: any[]): void {
...
//////////////////////////////////////////////////////////////////////////////
//G2C同步战斗时间
class Message_G2C_FIGHT_SYNC_TICKTIME extends MessageBase {
	fightTime
	public initObj(...args: any[]): void {
		this.fightTime = 0
	}
...
//翅膀发招
class Message_C2G_FIGHT_SPIRIT_SKILL extends MessageBase {
	fightSide
	skillId
	targetList
	public initObj(...args: any[]): void {
...
class Message_G2C_FIGHT_SPIRIT_POINT extends MessageBase {
	skillId
	leftPoint
	cooldownTime
	public initObj(...args: any[]): void {
...
class Message_C2G_FIGHT_FAST_END extends MessageBase {
	side
	public initObj(...args: any[]): void {
		this.side = 0
	}
...
//援助技能
class Message_C2G_FIGHT_ASSIST_SKILL extends MessageBase {
	side
	skillId
	public initObj(...args: any[]): void {
		this.side = 0
...
class Message_G2C_FIGHT_ASSIST_SKILL extends MessageBase {
	skillList
	commonCD
	public initObj(...args: any[]): void {
		this.skillList = []
...
//双方总输出统计
class Message_G2C_FIGHT_DAMAGE extends MessageBase {
	leftDamage
	rightDamage
	public initObj(...args: any[]): void {
		this.leftDamage = 0
