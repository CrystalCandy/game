...
//邮件列表
class Message_G2C_EMAIL_RECV extends MessageBase {
    mail_list: any[]
...
class Message_C2G_EMAIL_READ extends MessageBase {
    id
    public initObj(...args: any[]): void {
        this.id = 0
    }
...
class Message_G2C_EMAIL_READ extends MessageBase {
    id
    staust
    public initObj(...args: any[]): void {
        this.id = 0
...
class Message_C2G_EMAIL_GET_ANNEX extends MessageBase {
    id
    public initObj(...args: any[]): void {
        this.id = 0
    }
...
class Message_C2G_EMAIL_REMOVE extends MessageBase {
    mailId
    public initObj(...args: any[]): void {
        this.mailId = 0
    }
...
class Message_G2C_EMAIL_REMOVE extends MessageBase {
    mailId
    public initObj(...args: any[]): void {
        this.mailId = null
    }
...
class Message_C2G_EMAIL_ALL extends MessageBase {
    public initObj(...args: any[]): void {
