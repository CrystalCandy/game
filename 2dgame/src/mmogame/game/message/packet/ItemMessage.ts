...
class Message_C2G_ITEM_USE extends MessageBase{
id
count
public initObj(...args:any[]):void {
	this.id = 0
...
//伙伴进化
class Message_C2G_PET_DEVELOP_QUALITY extends MessageBase{
id
entryid
public initObj(...args:any[]):void {
	this.id = 0
...
class Message_G2C_PET_DEVELOP_QUALITY extends MessageBase{
petentryid
level
public initObj(...args:any[]):void {
	this.petentryid = 0
...
////////////////////////////////////////////////////////////////////////////////////-
// 查看商品列表
class Message_C2G_ITEM_TRADE_LIST extends MessageBase{
	first_type
public initObj(...args:any[]):void {
	this.first_type = 0
	//this.second_type = 0
...
// 获取商品列表
class Message_G2C_ITEM_TRADE_LIST extends MessageBase{
	first_type
	second_type
	itemList:any[]
public initObj(...args:any[]):void {
...
//商城单个物品信息
class Message_C2G_ITEM_TRADE_ITEM_INFO extends MessageBase{
entryId
public initObj(...args:any[]):void {
	this.entryId = 0
}
...
class Message_G2C_ITEM_TRADE_ITEM_INFO extends MessageBase{
	dealItemInfo
	first_type
public initObj(...args:any[]):void {
	this.first_type = 0
...
class Message_G2C_ITEM_TRADE_LIMIT extends MessageBase{
	limitList
public initObj(...args:any[]):void {
		this.limitList = {}
}
...
class Message_C2G_ITEM_SELL_LIST extends MessageBase{
static NPC_TYPE = 1
...
class Message_C2G_ITEM_BUY extends MessageBase{
	npc_id
	id
	count
	priceType
...
// 晶石购买物品
class Message_C2G_ITEM_TRADE_SALE extends MessageBase{
id
count
public initObj(...args:any[]):void {
	this.id = 0
...
////////////////////////////////////////////////////////////////////////////////////-
////使用王者英魂
class Message_C2G_FETE_PLAYER extends MessageBase{
	itemList
public initObj(...args:any[]):void {
		this.itemList = {}
}
...
////晶石兑换金币或者体力剩余次数
class Message_C2G_ACTIVE_DUIHUAN_SELECT extends MessageBase{
	index
public initObj(...args:any[]):void {
		this.index = null
}
...
class Message_G2C_ACTIVE_DUIHUAN_SELECT extends MessageBase{
	count
	cost
public initObj(...args:any[]):void {
		this.count = null
...
class Message_C2G_ACTIVE_DUIHUAN extends MessageBase{
	index
public initObj(...args:any[]):void {
		this.index = null
}
...
////////////////////////////////////////////////////////////////////////////////////////////////////////-
//溶解物品
class Message_C2G_ITEM_EQUIP_SPLIT extends MessageBase{
list
public initObj(...args:any[]):void {
			this.list = {}
}
...
////////////////////////-装备重铸//////////////////
class Message_C2G_EQUIP_CAST extends MessageBase{
	itemId
public initObj(...args:any[]):void {
		this.itemId = null
}
...
//装备重铸选择
class Message_C2G_EQUIP_CAST_CHOOSE extends MessageBase{
	itemId
public initObj(...args:any[]):void {
	this.itemId = null
}
...
class Message_C2G_EQUIP_CAST_CANCEL extends MessageBase{
	itemId
public initObj(...args:any[]):void {
	this.itemId = null
}
...
//初始化物品库
class Message_C2G_ITEM_ENTER_LOTTERY extends MessageBase{
...
//初始化结果
class Message_G2C_ITEM_ENTER_LOTTERY extends MessageBase{
...
//获取物品库
class Message_G2C_ITEM_LOTTERY_LIB extends MessageBase{
	ItemList
public initObj(...args:any[]):void {
		this.ItemList = null
}
...
class Message_C2G_ITEM_LOTTERY_REFRESH extends MessageBase{
...
//发送抽奖 一次和十次
class Message_C2G_ITEM_LOTTERY extends MessageBase{
	index
public initObj(...args:any[]):void {
		this.index = null
}
