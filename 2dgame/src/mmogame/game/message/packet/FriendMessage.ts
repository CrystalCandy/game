...
//}
//
class Message_G2C_FRIEND_LIST extends MessageBase {
    friend_list
    public initObj(...args: any[]): void {
        this.friend_list = {}
    }
...
class Message_G2C_FRIEND_OFFLINE_MESSAGE_COUNT extends MessageBase {
...
class Message_G2C_APPLY_FRIEND_INFO extends MessageBase {
    stranger_list: any[]
    public initObj(...args: any[]): void {
        this.stranger_list = []
        this.fireEvent = true
...
class Message_C2G_FRIEND_FIND extends MessageBase {
    searchName
    sendType
    public initObj(...args: any[]): void {
        this.searchName = ""
...
class Message_C2G_APPLY_FRIEND_ADD extends MessageBase {
    playerId
    public initObj(...args: any[]): void {
        this.playerId = null
    }
...
class Message_G2C_APPLY_FRIEND_ADD extends MessageBase {
...
class Message_C2G_APPLY_FRIEND_ADD_AGREE extends MessageBase {
    friendId
    isAgree
    public initObj(...args: any[]): void {
        this.friendId = null
...
class Message_G2C_APPLY_FRIEND_ADD_AGREE extends MessageBase {
    friendIdToDelete
...
class Message_C2G_FRIEND_DEL extends MessageBase {
    friendIdToDelete
    public initObj(...args: any[]): void {
        this.friendIdToDelete = null
    }
...
class Message_G2C_FRIEND_DEL extends MessageBase {
    friendIdToDelete
    public initObj(...args: any[]): void {
        this.friendIdToDelete = null
    }
...
class Message_G2C_FRIEND_ONLINE extends MessageBase {
    friendId
    public initObj(...args: any[]): void {
        this.friendId = null
    }
...
class Message_G2C_FRIEND_OFFLINE extends MessageBase {
    friendId
    public initObj(...args: any[]): void {
        this.friendId = null
    }
...
class Message_C2G_FRIEND_RECOMMEND_FRIENDS extends MessageBase {
    public initObj(...args: any[]): void {
...
class Message_G2C_FRIEND_RECOMMEND_FRIENDS extends MessageBase {
...
class Message_C2G_DELETE_RECOMMEND_FRIEND extends MessageBase {
    deleteID
    public initObj(...args: any[]): void {
        this.deleteID = null
    }
...
class Message_G2C_DELETE_RECOMMEND_FRIEND extends MessageBase {
    public initObj(...args: any[]): void {
        //this.deleteID= null
    }
    pack(writer) {
...
class Message_G2C_FRIEND_SINGLE_INFO extends MessageBase {
    tempFriend
    getSendType
    public initObj(...args: any[]): void {
        this.tempFriend = null
...
class Message_C2G_FRIEND_SEND_MESSAGE_ONE extends MessageBase {
    receiverId
    data
    public initObj(...args: any[]): void {
    ...
    //class Message_G2C_FRIEND_SEND_MESSAGE_ONE extends MessageBase{
    //public initObj(...args:any[]):void {
    //	/*
...
class Message_G2C_FRIEND_SEND_MESSAGE_SUCCESS extends MessageBase {
    succeed
    public initObj(...args: any[]): void {
        this.succeed = 0
    }
...
class Message_G2C_STRANGER_INFO extends MessageBase {
    chat_stranger
    public initObj(...args: any[]): void {
...
class Message_C2G_PLAYER_SET_CARD extends MessageBase {
    str_QQ
    str_WeChat
    isShow
    str_Phone
...
class Message_G2C_PLAYER_SET_CARD extends MessageBase {
    str_QQ
    str_WeChat
    public initObj(...args: any[]): void {
        //没数据返回，有返回就是成功 
...
class Message_C2G_PLAYER_GET_CARD extends MessageBase {
    playerName
    public initObj(...args: any[]): void {
...
class Message_G2C_PLAYER_GET_CARD extends MessageBase {
    playerID
    playerCardInfo
    public initObj(...args: any[]): void {
...
class Message_C2G_ROLE_ADD_BLACK_ROLE extends MessageBase {
    playerID
    playerName
    public initObj(...args: any[]): void {
        this.playerID = null
...
class Message_C2G_ROLE_REMOVE_BLACK_ROLE extends MessageBase {
    playerID
    public initObj(...args: any[]): void {
        this.playerID = null
    }
...
class Message_C2G_ROLE_REQUEST_BLACK_ROLE extends MessageBase {
    public initObj(...args: any[]): void {
...
class Message_G2C_ROLE_RESONPD_BLACK_ROLE extends MessageBase {
    blackList
    public initObj(...args: any[]): void {
        this.blackList = null
    }
...
class Message_C2G_REJECT_FRIEND_ADD extends MessageBase {
    sendStatus
    public initObj(...args: any[]): void {
...
class Message_C2G_REJECT_FRIEND_ADD_STATE extends MessageBase {
    public initObj(...args: any[]): void {
...
class Message_G2C_REJECT_FRIEND_ADD extends MessageBase {
    getServerAddType
    public initObj(...args: any[]): void {
...
class Message_C2G_CHAT_GROUP_CREATE extends MessageBase {
    public initObj(...args: any[]): void {
...
class Message_G2C_CHAT_GROUP_CREATE extends MessageBase {
    groupId
    public initObj(...args: any[]): void {
        this.groupId = 0
    }
...
class Message_G2C_CHAT_GROUP_UPDATE_INFO extends MessageBase {
    groupid
    masterid
    mastername
    masterbody
...
class Message_C2G_CHAT_GROUP_QUERY_MEMBERS extends MessageBase {
    groupId
    public initObj(...args: any[]): void {
        this.groupId = 0
    }
...
class Message_G2C_CHAT_GROUP_QUERY_MEMBERS extends MessageBase {
    membersCount
    members
    groupid
    public initObj(...args: any[]): void {
...
class Message_C2G_CHAT_GROUP_INVITE_JOIN extends MessageBase {
    groupId
    inviteList
    public initObj(...args: any[]): void {
        this.groupId = null
...
class Message_G2C_CHAT_GROUP_INVITE_JOIN extends MessageBase {
    bodyId
    inviteName
    chatGroupid
    chatGroupName
...
class Message_C2G_CHAT_GROUP_AGREE_JOIN extends MessageBase {
    groupId
    agree
    public initObj(...args: any[]): void {
        this.groupId = null
...
class Message_G2C_CHAT_GROUP_AGREE_JOIN extends MessageBase {
    groupId
    public initObj(...args: any[]): void {
        this.groupId = null
    }
...
class Message_C2G_CHAT_GROUP_QUIT extends MessageBase {
    groupId
    public initObj(...args: any[]): void {
        this.groupId = 0
    }
...
class Message_G2C_CHAT_GROUP_QUIT extends MessageBase {
    groupId
    public initObj(...args: any[]): void {
        this.groupId = 0
    }
...
class Message_G2C_CHAT_GROUP_EXPELEE extends MessageBase {
    groupid
    public initObj(...args: any[]): void {
        this.groupid = 0
    }
...
class Message_C2G_CHAT_GROUP_EXPELEE extends MessageBase {
    groupid
    expeleeid
    public initObj(...args: any[]): void {
        this.groupid = 0
...
class Message_C2G_CHAT_GROUP_CHAT extends MessageBase {
    public initObj(...args: any[]): void {
...
class Message_G2C_CHAT_GROUP_CHAT extends MessageBase {
    groupContent
    public initObj(...args: any[]): void {
        this.groupContent = {}
    }
...
class Message_C2G_CHAT_GROUP_LIST extends MessageBase {
    public initObj(...args: any[]): void {
...
class Message_G2C_CHAT_GROUP_LIST extends MessageBase {
    GroupCount
    GroupList: any[]
    public initObj(...args: any[]): void {
        this.GroupCount = 0
...
class Message_G2C_NO_TROUBLE_SETTING extends MessageBase {
    groupList
    public initObj(...args: any[]): void {
        this.groupList = {}
    }
...
class Message_C2G_NO_TROUBLE_SETTING extends MessageBase {
    mode
    GroupId
    public initObj(...args: any[]): void {
...
class Message_G2C_SELECT_NO_TROUBLE_SETTING extends MessageBase {
    groupList
    public initObj(...args: any[]): void {
...
class Message_C2G_SELECT_NO_TROUBLE_SETTING extends MessageBase {
    public initObj(...args: any[]): void {
...
class Message_C2G_CHAT_GROUP_INVITE_LIST extends MessageBase {
    public initObj(...args: any[]): void {
...
class Message_G2C_CHAT_GROUP_INVITE_LIST extends MessageBase {
    inviteCount
    inviteList
...
class Message_G2C_CHAT_GROUP_REALSE extends MessageBase {
    groupId
...
class Message_C2G_FRIEND_INFO_REQUEST extends MessageBase {
    public initObj(...args: any[]): void {
...
//赠送体力
class Message_C2G_FRIEND_GIVE_ITEM extends MessageBase {
    friendIdList
    public initObj(...args: any[]): void {
        //this.friendId = 0
        this.friendIdList = {}
...
class Message_G2C_FRIEND_GIVE_ITEM extends MessageBase {
    friendIdList
    public initObj(...args: any[]): void {
        this.friendIdList = {}
    }
...
class Message_C2G_FRIEND_GIVE_ITEM_RECORD extends MessageBase {
    public initObj(...args: any[]): void {
...
//某个好友的信息更新
class Message_G2C_FRIEND_UPPDATE_INFO extends MessageBase{
    friendInfo:FriendInfo;
public initObj(...args:any[]):void {
	this.friendInfo = null
}
