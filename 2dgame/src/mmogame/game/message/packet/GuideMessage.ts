...
class Message_G2C_ROLE_NEWBIE_SETTING_RECORD extends MessageBase {  //功能开启
	errantry
	public initObj(...args: any[]): void {
		this.errantry = 0
	}
...
class Message_C2G_ROLE_NEWBIE_CHANGE extends MessageBase {  //指引功能记录（改变）.
	errantry
	changeType
	public initObj(...args: any[]): void {
		this.errantry = 0
...
class Message_C2G_ROLE_NEWBIE_SAVE_RECORD extends MessageBase {  //指引记录
	record
	public initObj(...args: any[]): void {
		this.record = null
	}
...
class Message_C2G_SET_SEX extends MessageBase {
	sexId
	public initObj(...args: any[]): void {
		this.sexId = 0
	}
