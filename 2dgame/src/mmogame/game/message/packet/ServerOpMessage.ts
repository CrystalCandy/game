// TypeScript file
//心跳ping
class Message_CMSG_PING extends MessageBase{
    index:number;
    temp:number;
...
//心跳pong
class Message_SMSG_PONG extends MessageBase{
    ping:number;
    serverTime:number;
    public initObj(...params:any[]):void{
...
class Message_CMSG_LOGIN extends MessageBase{
    hostname:string;
    accountId:string;
    sessionId:string;
    public initObj(...params:any[]):void{
...
class Message_SMSG_LOGIN extends MessageBase{
    result:string;
    serverTime:string;
    public initObj(...params:any[]):void{
...
//用户服务器登陆请求
class Message_CMSG_LOGIN_USER extends MessageBase{
    hostname:string;
    verify:string;
    username:string;
...
//用户服务器通知登陆
class Message_SMSG_LOGIN_USER extends MessageBase{
    result:number;
    accountId:string;
    sessionId:string;
    serverTime:number;
...
//踢出服务器
class Message_SMSG_LOGOUT extends MessageBase{
    result:number;
    public initObj(...params:any[]):void{
        this.addReadProtocol(MessageProtocol.UINT16, "result");
    }
