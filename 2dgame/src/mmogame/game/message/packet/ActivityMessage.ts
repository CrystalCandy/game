...
//////////////////////////////////////////////////////////////////////////////////
//-活动BUFF更新
class Message_G2C_BUFF_UPDATE extends MessageBase {
    buffName
    buffLeftTime
    buffData
...
class Message_G2C_BUFF_REMOVE extends MessageBase {
    buffName
    public initObj(...args: any[]): void {
        this.buffName = null
    }
...
class Message_C2G_ROLE_RANK extends MessageBase {
    rankType
    index
    public initObj(...args: any[]): void {
        this.rankType = 0
...
class Message_G2C_ROLE_RANK extends MessageBase {
    ranklist:any[]
    ranktype
...
class Message_C2G_EXCITE_DATA extends MessageBase {
    exciteType
    public initObj(...args: any[]): void {
...
class Message_G2C_EXCITE_DATA extends MessageBase {
    exciteData
    exciteType
    public initObj(...args: any[]): void {
...
class Message_C2G_EXCITE_GET_PRIZE extends MessageBase {
    exciteType
    getIndex
    public initObj(...args: any[]): void {
        this.exciteType = null
...
class Message_C2G_ACTIVITY_TIME_INFO extends MessageBase {
    actIndexList
    public initObj(...args: any[]): void {
        this.actIndexList = {}
    }
...
class Message_G2C_ACTIVITY_TIME_INFO extends MessageBase {
    stateList
    public initObj(...args: any[]): void {
        this.stateList = {}
    }
...
class Message_G2C_RECHARGE_REWARD_INFO extends MessageBase {
    list
...
class Message_C2G_RECHARGE_REWARD_INFO extends MessageBase {
    public initObj(...args: any[]): void {
...
class Message_C2G_BUY_VIP_GIFTS extends MessageBase {
    public initObj(...args: any[]): void {
...
class Message_G2C_WAR_HORN_REWARD_INFO extends MessageBase {
    list:any;
    public initObj(...args: any[]): void {
        this.list = {}
    }
...
class Message_C2G_WAR_HORN_REWARD_INFO extends MessageBase {
    public initObj(...args: any[]): void {
...
class Message_C2G_GET_WAR_HORN_REWARD extends MessageBase {
    index
    public initObj(...args: any[]): void {
        this.index = null
    }
...
class Message_G2C_QIANDAO_TIME extends MessageBase {
    times
    isget
    public initObj(...args: any[]): void {
        this.times = 0
...
class Message_C2G_QIANDAO_AWARD extends MessageBase {
    Date1
    public initObj(...args: any[]): void {
        this.Date1 = 0
    }
...
class Message_G2C_GLOBAL_SERVER_EVENT extends MessageBase {
    event
    data
    public initObj(...args: any[]): void {
        this.event = 0
...
class Message_C2G_ROLE_GET_POWER extends MessageBase {
    public initObj(...args: any[]): void {
...
class Message_C2G_ROLE_GET_NEW_SUMMON_STONE extends MessageBase {
    public initObj(...args: any[]): void {
...
class Message_C2G_SEVEN_DAY_PRIZE_INFO extends MessageBase {
    public initObj(...args: any[]): void {
...
class Message_C2G_SEVEN_DAY_GET_PRIZE extends MessageBase {
    getIndex
    prizeIndex
    public initObj(...args: any[]): void {
...
class Message_G2C_SEVEN_DAY_GET_PRIZE extends MessageBase {
    public initObj(...args: any[]): void {
...
class Message_C2G_OPERATE_INFO_LIST extends MessageBase {
    public initObj(...args: any[]): void {
...
class Message_G2C_OPERATE_INFO_UPDATE extends MessageBase {
    singalInfo:any
    singalIndex:any
    public initObj(...args: any[]): void {
...
class Message_C2G_OPERATE_INFO_PRIZE extends MessageBase {
    index
    public initObj(...args: any[]): void {
        this.index = 0
    }
...
class Message_C2G_OPERATE_ACTIVE_PRIZE extends MessageBase {
    index
    public initObj(...args: any[]): void {
        this.index = 0
    }
...
class Message_G2C_OPERATE_ACTIVE_PRIZE extends MessageBase {
    public initObj(...args: any[]): void {
...
class Message_C2G_PLAT_FORM_CODE extends MessageBase {
    code
    public initObj(...args: any[]): void {
        this.code = null
    }
    ...
    //////////////////////邀请码start////////////////////////////////////////////-
    //查询奖励信息
class Message_C2G_FRIEND_INVITE_CODE_INFO extends MessageBase {
    public initObj(...args: any[]): void {
...
//邀请人数
class Message_G2C_FRIEND_INVITE_CODE_INFO extends MessageBase {
    finishFlag
    friendsNum
    myInviteCode
    public initObj(...args: any[]): void {
...
//查询奖励信息返回
class Message_G2C_INVITE_PRIZE_INFO extends MessageBase {
    list
    public initObj(...args: any[]): void {
        this.list = {}
    }
...
//领取奖励
class Message_C2G_GET_INVITE_PRIZE extends MessageBase {
    prizeIndex
    public initObj(...args: any[]): void {
        this.prizeIndex = 0
    }
...
//填写邀请码
class Message_C2G_INVITE_FILL_OUT_CODE extends MessageBase {
    code
    public initObj(...args: any[]): void {
        this.code = ""
    }
...
class Message_G2C_NEW_SERVER_RANK_INFO extends MessageBase{
    openTime
public initObj(...args:any[]):void {
	this.openTime = null
}
...
class Message_C2G_FESTIVAL_SINGLEDAY_INFO extends MessageBase{
public initObj(...args:any[]):void {
...
class Message_G2C_FESTIVAL_SINGLEDAY_INFO extends MessageBase{
    beginTime
    endTime
    itemList
public initObj(...args:any[]):void {
