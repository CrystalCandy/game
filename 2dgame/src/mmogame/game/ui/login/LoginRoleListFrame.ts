...
class LoginRoleListFrame extends BaseWnd {
    ...
    initItemWindow(wnd) {
        ...
        let mElemInfo1: any = [
            ...
            { ["index_type"]: gui.Button, ["name"]: name + "sure_btn", ["title"]: Localize_cns("LOGIN_INFO"), ["font"]: "ht_24_cc_stroke", ["image"]: "ty_tongYongBt01", ["color"]: gui.Color.white, ["x"]: 430, ["y"]: 20, ["w"]: 120, ["h"]: 70, ["event_name"]: egret.TouchEvent.TOUCH_TAP, ["fun_index"]: this.onClickSure },
    ...
    refreshUI() {
        ...
        for (let k = 0; k < list.length; k++) {
            ...
            let window = scroll.getItemWindow(k, 570, 110, 0, 5, 5)
