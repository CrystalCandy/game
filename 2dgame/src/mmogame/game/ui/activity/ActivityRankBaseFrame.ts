...
class ActivityRankBaseFrame extends BaseWnd {
	...
	initItemWindow(window) {
		...
		let mElemInfo: any = [
            ...
            { ["index_type"] : eui.Label,		["name"] : name +"_rank",	["title"]: "",   		["font"] : "ht_22_cc",   ["color"] : gui.Color.black,		["x"] : 0,     ["y"] : 15,		["w"] : 80,["h"] : 25,	 ["fun_index"] : null, ["messageFlag"] : true,},
			{ ["index_type"] : eui.Label,		["name"] : name +"_name",	["title"]: Localize_cns("BOSS_TXT12"),   		["font"] : "ht_22_cc",   ["color"] : gui.Color.black,		["x"] : 80,     ["y"] : 15,		["w"] : 140,["h"] : 25,	 ["fun_index"] : null, ["messageFlag"] : true,},
    ...
    refreshHeroRank(myRank, myConfig) {
