	...
	public onHide(): void {
	 ...
	 onRefresh() {
		...
		for (let i = 0; i < size_t(rewardInfo); i++) {
            ...
            let window = this.scroll.getItemWindow(i, 565, 145, 0, 0, 5)
	...
	initItemWindow(window){
		...
		let Info: any = [
               //背景
                ...
                { ["index_type"]: gui.Button, ["name"]: name + "getBtn", ["title"]: "", ["font"]: "ht_20_cc_stroke", ["image"]: "ty_tongYongBt3", ["color"]: gui.Color.white, ["x"]: 395, ["y"]: 40, ["w"]: 117, ["h"]: 51, ["event_name"]: egret.TouchEvent.TOUCH_TAP, ["fun_index"]: this.onClick},
