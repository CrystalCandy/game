...
class IconMsgFrame extends BaseWnd {
    ...
    createLayout() {
        ...
        let mElemInfo2: any = [
            { ["index_type"]: gui.Grid9Image, ["name"]: "iconbg", ["title"]: null, ["font"]: null, ["image"]: "ty_zhuangBeiBg00", ["color"]: gui.Color.white, ["percentWidth"]: 100, ["percentHeight"]: 100, ["event_name"]: egret.TouchEvent.TOUCH_TAP, ["fun_index"]: null },
        ]
