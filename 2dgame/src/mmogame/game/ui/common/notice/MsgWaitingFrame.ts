...
class MsgWaitingFrame extends BaseWnd {
    ...
    createFrame() {
        ...
        let mElemInfo: any = [
            { ["index_type"]: gui.Grid9Image, ["name"]: "infobg", ["image"]: "ty_zhuangBeiBg00", ["color"]: gui.Color.white, ["horizontalCenter"]:0, ["verticalCenter"]:0, ["w"]: 240, ["h"]: 40, ["event_name"]: null, ["fun_index"]: null },
