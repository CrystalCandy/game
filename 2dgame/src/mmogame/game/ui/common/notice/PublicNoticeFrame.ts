class PublicNoticeFrame extends BaseWnd {
    ...
    createLayout() {
        ...
        let info: any = [
            {["index_type"] : gui.Grid9Image,	["name"] : "gongGaoBg",			["title"] :null, 	   ["font"] : null,			["image"] : "ty_tipsDi",	["color"] : gui.Color.darksalmon,	["x"] : 0, ["y"] : 0, ["w"]: 640, ["h"]: 50,["event_name"] : null,["fun_index"] : null},
