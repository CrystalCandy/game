...
class ChatBubbleFrame extends BaseWnd {
    ...
    createFrame() {
        ...
        this.mElemList = {}
        let elemInfo: any = [
            { ["index_type"]: gui.Grid9Image, ["name"]: "bg", ["title"]: "", ["font"]: "ht_20_cc", ["image"]: "NPCduiHuaKuang", ["color"]: gui.Color.white, ["x"]: 0, ["y"]: 0, ["w"]: width, ["h"]: height, ["event_name"]: null, ["fun_index"]: null, },
