	...
	export class RankItem extends eui.ItemRenderer {
		...
		constructor() {
			...
			let Info = [
                ...
                { ["index_type"]: eui.Label, ["name"]: "forceTitle",  ["parent"]: "plrBg", ["title"]:"", ["font"]:"ht_22_lc", ["color"]: gui.Color.zongse, ["x"]: 5, ["y"]: 35, ["w"]: 130, ["h"]: 25, ["event_name"]: egret.TouchEvent.TOUCH_TAP, ["fun_index"]: null },
