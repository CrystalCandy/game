...
class DailyLoginFrame extends BaseWnd {
    ...
    initItemWindow(window) {
        ...
        let mElemInfo: any = [
            ...
            { ["index_type"]: eui.Label, ["name"]: name + "_day", ["title"]: "", ["font"]: "ht_22_cc", ["color"]: gui.Color.black, ["x"]: 385, ["y"]: 10, ["w"]: 160, ["h"]: 25, ["fun_index"]: null, ["messageFlag"]: true, },
            ...
            { ["index_type"]: eui.Label, ["name"]: name + "_status", ["title"]: "", ["font"]: "ht_22_cc", ["color"]: gui.Color.black, ["x"]: 405, ["y"]: 50, ["w"]: 120, ["h"]: 50, ["fun_index"]: null, ["messageFlag"]: true, },
        ]
    ...
    refreshFrame() {
        ...
        for (let i = 1; i <= count; i++) {
            let config = GameConfig.DailyLoginConfig[i]
            list.push(config)
        }
        ...
        for (let k = 0; k < list.length; k++) {
            let v = list[k]
            let window = scroll.getItemWindow(k, 550, 120, 0, 0, 0)
