...
class FightRecordFrame extends BaseWnd {
    ...
    createFrame() {
        ...
        let mElemInfo: any = [
            ...
            { ["index_type"]: eui.Image, ["name"]: "bgtitle", ["title"]: null, ["font"]: null, ["image"]: "ty_biaoTiHuaWen01", ["color"]: gui.Color.white, ["horizontalCenter"]: 0, ["y"]: 30, ["event_name"]: null, ["fun_index"]: null },
            { ["index_type"]: eui.Label, ["name"]: "title", ["parent"]: "bgtitle", ["title"]: Localize_cns("FIGHT_TXT2"), ["font"]: "ht_28_cc_stroke", ["color"]: gui.Color.white, ["horizontalCenter"]: 0, ["y"]: 16, ["event_name"]: null, ["fun_index"]: null },

            { ["index_type"]: gui.Grid9Image, ["name"]: "scroll_bg", ["title"]: null, ["font"]: null, ["image"]: "ty_UIBg02", ["color"]: gui.Color.navajowhite, ["x"]: 40, ["y"]: 95, ["w"]: 560, ["h"]: 760, ["event_name"]: null, ["fun_index"]: null },
        ...
        let name = "scroll"
        let window = UIScrollList.newObj(this.mLayoutNode, "scroll", 5, 10, 550, 740, this.mElemList["scroll_bg"])
        this.scroll = window
    ...
    refreshFrame() {
        ...
        for (let index = 0; index < content.length; index++) {
            let xml = content[index]
             ...
             let window = scroll.getItemWindow(index, scroll.getWidth(), 100, 0, 0)
