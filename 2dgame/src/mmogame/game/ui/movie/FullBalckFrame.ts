...
class FullBalckFrame extends BaseWnd {
	...
	create_frame() {
		...
		let ElemInfo: any = [
			...
			{ ["index_type"]: eui.Rect, ["name"]: "wnd", ["color"]: gui.Color.black, ["alpha"]: 1, ["x"]: 0, ["y"]: 0, ["percentWidth"]: 100, ["percentHeight"]: 100, ["event_name"]: null, ["fun_index"]: null, ["touchChildren"]: true, },
		]
