...
class RolePropertyFrame extends BaseWnd {
    ...
    public onLoad(): void {
		...
		let mElemInfo: any = [
            ...
            { ["index_type"]: eui.Label, ["name"]: "label_des", ["title"]: Localize_cns("ROLE_PROPERTY"), ["font"]: "ht_24_cc", ["image"]: "", ["color"]: gui.Color.black, ["x"]: 142, ["y"]: 35, ["w"] : 217, ["h"] : 24},
    ...
    onRefresh(){
        ...
        for(let k in info){
            ...
            let name = GetPropertyName(k) + vStr + "#br#br#br"
            if(count % 2 == 0){
                rd_2_str += name
            }else{
                rd_1_str += name
