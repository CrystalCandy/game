...
class TaskSystem extends BaseSystem {
	...
	isTaskHasFinished(taskId) {
		let flag = table_isExsit(this.finishTaskList, taskId)
		return flag
	}
	...
	getNewTaskNpcId() {
		...
		for (let i = IsolationCharacterId.TaskNpcBegin; i <= IsolationCharacterId.TaskNpcEnd, -1; i++) {
