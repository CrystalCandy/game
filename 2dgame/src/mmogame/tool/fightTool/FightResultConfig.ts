...
test_skill_prepare_1.castCount = 0
...
test_skill_interval_1.castCount = 0
...
test_skill_interval_2.targetList = targetList
...
test_skill_interval_3.target = FightResultSpace.caster + FightResultSpace.count
test_skill_interval_3.targetList = targetList
...
test_skill_interval_3.fightPowers[0].target = FightResultSpace.caster + FightResultSpace.count
...
test_skill_interval_4.code = resultOptions.RCODE_SPELL_INTERVAL_END
test_skill_interval_4.spellId = 9999
test_skill_interval_4.caster = FightResultSpace.caster
test_skill_interval_4.casterList = 0
test_skill_interval_4.target = FightResultSpace.caster + FightResultSpace.count
test_skill_interval_4.targetList = targetList
test_skill_interval_4.protector = 0
test_skill_interval_4.fail = 0
test_skill_interval_4.castCount = 0
test_skill_interval_4.powerCount = 0
