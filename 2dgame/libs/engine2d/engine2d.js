...
(function (map) {
    var LogicSprite = (function (_super) {
        ...
        LogicSprite.prototype._updateMask = function () {
            ...
            if (pMask.IsMask(map.FLOOR((leftX + rightX) / 2), bottomY) && pMask.IsMask(map.FLOOR((leftX + rightX) / 2), (topY + bottomY) / 2))
                maskAlpha = 128;
...
(function (core) {
    ...
    var ResManager = (function (_super) {
        ...
        ResManager.prototype.init = function () {
            ...
            RES.setMaxLoadingThread(5); //并发线程
        ...
        ResManager.prototype.getRootPath = function (rootPath) {
        ...
        ResManager.prototype.fetchVersion = function (cb, thisObj, userData) {
            var callback = {
        ...
        ResManager.prototype.addZipPacket = function (key, callback) {
            ...
            var zipCallback = {
                onResItemLoad: function (res) {
                    ...
                    if (zip) {
                        //res.retain();
                        _this.mZipList[res.getKey()] = zip;
                        if (callback)
                            callback.onZipItemLoad(res.getKey(), -1);
                    }
                    else {
                        if (callback)
                            callback.onZipItemLoad(key, 0);
        ...
        ResManager.prototype.startH5CrossOrigin = function (crossRootPath) {
            if (crossRootPath == null)
                return;
            this.mbH5CrossOrign = true;
            //重新设置跨域
            var vc = new RES.web.Html5VersionController();
        ...
        ResManager.prototype.onItemLoadSuccess = function (data, key, fromzip) {
            if (data == null) {
                TLog.Warn("onItemLoadSuccess data null ->" + key);
                return;
            }
            fromzip = !!fromzip;
            var path = key;
        ...
        ResManager.prototype.onItemLoadError = function (event) {
            if (event.groupName != "") {
                ...
                this.mErrorResPathMap[key] = true;
                var icbList = this.mItemCallbackMap[key];
                if (icbList) {
                    icbList.forEach(function (cb) {
            ...
            TLog.Error("onItemLoadError:" + event.resItem.name + " Url:" + event.resItem.url + " has failed to load");
        };
        return ResManager;
    }(TClass));
...
(function (core) {
    var SoundManager = (function (_super) {
        ...
        SoundManager.prototype.playEffect = function (name) {
            ...
            core.ResManager.getInstance().loadResAsyn(name, callback);
        };
        SoundManager.prototype.playMusic = function (name, loop) {
            ...
            this.mCurrentMusicName = name;
            core.ResManager.getInstance().loadResAsyn(name, this);
        };
...
(function (core) {
    ...
    var TextureManager = (function (_super) {
        ...
        TextureManager.prototype.onUpdate = function () {
            var _this = this;
            //检查bitmapData是否没有引用了
            this.delayTime += core.TimeStamp.DelayTime;
            if (this.delayTime > this.mCheckTime) {
                ...
                for (var k in this.mTextureResMap) {
                    ...
                    if (textureRes.noUseBeginTime >= 0 && textureRes.noUseBeginTime < validTime) {
...
(function (gui) {
    ...
    var ColorTable;
    var ColorNameIndexMap;
    function GetColorFromName(colorName) {
        if (ColorTable == null) {
            InitTable();
        }
        if (colorName in ColorNameIndexMap) {
            var index = ColorNameIndexMap[colorName];
    ...
    function InitTable() {
        ColorTable = [];
        ColorNameIndexMap = {};
        ColorTable[0] = Color.aliceblue;
        ColorTable[1] = Color.antiquewhite;
        ColorTable[2] = Color.aqua;
        ColorTable[3] = Color.aquamarine;
        ColorTable[4] = Color.azure;
        ColorTable[5] = Color.beige;
        ColorTable[6] = Color.bisque;
        ColorTable[7] = Color.black;
        ColorTable[8] = Color.blanchedalmond;
        ColorTable[9] = Color.blue;
        ColorTable[10] = Color.blueviolet;
        ColorTable[11] = Color.brown;
        ColorTable[12] = Color.burlywood;
        ColorTable[13] = Color.cadetblue;
        ColorTable[14] = Color.chartreuse;
        ColorTable[15] = Color.chocolate;
        ColorTable[16] = Color.coral;
        ColorTable[17] = Color.cornflowerblue;
        ColorTable[18] = Color.cornsilk;
        ColorTable[19] = Color.crimson;
        ColorTable[20] = Color.cyan;
        ColorTable[21] = Color.darkblue;
        ColorTable[22] = Color.darkcyan;
        ColorTable[23] = Color.darkgoldenrod;
        ColorTable[24] = Color.darkgray;
        ColorTable[25] = Color.darkgreen;
        ColorTable[26] = Color.darkkhaki;
        ColorTable[27] = Color.darkmagenta;
        ColorTable[28] = Color.darkolivegreen;
        ColorTable[29] = Color.darkorange;
        ColorTable[30] = Color.darkorchid;
        ColorTable[31] = Color.darkred;
        ColorTable[32] = Color.darksalmon;
        ColorTable[33] = Color.darkseagreen;
        ColorTable[34] = Color.darkslateblue;
        ColorTable[35] = Color.darkslategray;
        ColorTable[36] = Color.darkturquoise;
        ColorTable[37] = Color.darkviolet;
        ColorTable[38] = Color.deeppink;
        ColorTable[39] = Color.deepskyblue;
        ColorTable[40] = Color.dimgray;
        ColorTable[41] = Color.dodgerblue;
        ColorTable[42] = Color.firebrick;
        ColorTable[43] = Color.floralwhite;
        ColorTable[44] = Color.forestgreen;
        ColorTable[45] = Color.fuchsia;
        ColorTable[46] = Color.gainsboro;
        ColorTable[47] = Color.ghostwhite;
        ColorTable[48] = Color.gold;
        ColorTable[49] = Color.goldenrod;
        ColorTable[50] = Color.gray;
        ColorTable[51] = Color.green;
        ColorTable[52] = Color.greenyellow;
        ColorTable[53] = Color.honeydew;
        ColorTable[54] = Color.hotpink;
        ColorTable[55] = Color.indianred;
        ColorTable[56] = Color.indigo;
        ColorTable[57] = Color.ivory;
        ColorTable[58] = Color.khaki;
        ColorTable[59] = Color.lavender;
        ColorTable[60] = Color.lavenderblush;
        ColorTable[61] = Color.lawngreen;
        ColorTable[62] = Color.lemonchiffon;
        ColorTable[63] = Color.lightblue;
        ColorTable[64] = Color.lightcoral;
        ColorTable[65] = Color.lightcyan;
        ColorTable[66] = Color.lightgoldenrodyellow;
        ColorTable[67] = Color.lightgreen;
        ColorTable[68] = Color.lightgrey;
        ColorTable[69] = Color.lightpink;
        ColorTable[70] = Color.lightsalmon;
        ColorTable[71] = Color.lightseagreen;
        ColorTable[72] = Color.lightskyblue;
        ColorTable[73] = Color.lightslategray;
        ColorTable[74] = Color.lightsteelblue;
        ColorTable[75] = Color.lightyellow;
        ColorTable[76] = Color.lime;
        ColorTable[77] = Color.limegreen;
        ColorTable[78] = Color.linen;
        ColorTable[79] = Color.magenta;
        ColorTable[80] = Color.maroon;
        ColorTable[81] = Color.mediumaquamarine;
        ColorTable[82] = Color.mediumblue;
        ColorTable[83] = Color.mediumorchid;
        ColorTable[84] = Color.mediumpurple;
        ColorTable[85] = Color.mediumseagreen;
        ColorTable[86] = Color.mediumslateblue;
        ColorTable[87] = Color.mediumspringgreen;
        ColorTable[88] = Color.mediumturquoise;
        ColorTable[89] = Color.mediumvioletred;
        ColorTable[90] = Color.midnightblue;
        ColorTable[91] = Color.mintcream;
        ColorTable[92] = Color.mistyrose;
        ColorTable[93] = Color.moccasin;
        ColorTable[94] = Color.navajowhite;
        ColorTable[95] = Color.navy;
        ColorTable[96] = Color.oldlace;
        ColorTable[97] = Color.olive;
        ColorTable[98] = Color.olivedrab;
        ColorTable[99] = Color.orange;
        ColorTable[100] = Color.orangered;
        ColorTable[101] = Color.orchid;
        ColorTable[102] = Color.palegoldenrod;
        ColorTable[103] = Color.palegreen;
        ColorTable[104] = Color.paleturquoise;
        ColorTable[105] = Color.palevioletred;
        ColorTable[106] = Color.papayawhip;
        ColorTable[107] = Color.peachpuff;
        ColorTable[108] = Color.peru;
        ColorTable[109] = Color.pink;
        ColorTable[110] = Color.plum;
        ColorTable[111] = Color.powderblue;
        ColorTable[112] = Color.purple;
        ColorTable[113] = Color.red;
        ColorTable[114] = Color.rosybrown;
        ColorTable[115] = Color.royalblue;
        ColorTable[116] = Color.saddlebrown;
        ColorTable[117] = Color.salmon;
        ColorTable[118] = Color.sandybrown;
        ColorTable[119] = Color.seagreen;
        ColorTable[120] = Color.seashell;
        ColorTable[121] = Color.sienna;
        ColorTable[122] = Color.silver;
        ColorTable[123] = Color.skyblue;
        ColorTable[124] = Color.slateblue;
        ColorTable[125] = Color.slategray;
        ColorTable[126] = Color.snow;
        ColorTable[127] = Color.springgreen;
        ColorTable[128] = Color.steelblue;
        ColorTable[129] = Color.tan;
        ColorTable[130] = Color.teal;
        ColorTable[131] = Color.thistle;
        ColorTable[132] = Color.tomato;
        ColorTable[133] = Color.turquoise;
        ColorTable[134] = Color.violet;
        ColorTable[135] = Color.wheat;
        ColorTable[136] = Color.white;
        ColorTable[137] = Color.whitesmoke;
        ColorTable[138] = Color.yellow;
        ColorTable[139] = Color.yellowgreen;
        ColorTable[140] = Color.zongse;
        ColorTable[141] = Color.zongse02;
        ColorTable[142] = Color.rouse;
        ColorTable[143] = Color.rouse02;
        ColorTable[144] = Color.lvse;
        ColorTable[145] = Color.hongse;
        ColorTable[146] = Color.lvse02;
        ColorTable[147] = Color.ublack;
        ColorNameIndexMap["aliceblue"] = 0;
        ColorNameIndexMap["antiquewhite"] = 1;
        ColorNameIndexMap["aqua"] = 2;
        ColorNameIndexMap["aquamarine"] = 3;
        ColorNameIndexMap["azure"] = 4;
        ColorNameIndexMap["beige"] = 5;
        ColorNameIndexMap["bisque"] = 6;
        ColorNameIndexMap["black"] = 7;
        ColorNameIndexMap["blanchedalmond"] = 8;
        ColorNameIndexMap["blue"] = 9;
        ColorNameIndexMap["blueviolet"] = 10;
        ColorNameIndexMap["brown"] = 11;
        ColorNameIndexMap["burlywood"] = 12;
        ColorNameIndexMap["cadetblue"] = 13;
        ColorNameIndexMap["chartreuse"] = 14;
        ColorNameIndexMap["chocolate"] = 15;
        ColorNameIndexMap["coral"] = 16;
        ColorNameIndexMap["cornflowerblue"] = 17;
        ColorNameIndexMap["cornsilk"] = 18;
        ColorNameIndexMap["crimson"] = 19;
        ColorNameIndexMap["cyan"] = 20;
        ColorNameIndexMap["darkblue"] = 21;
        ColorNameIndexMap["darkcyan"] = 22;
        ColorNameIndexMap["darkgoldenrod"] = 23;
        ColorNameIndexMap["darkgray"] = 24;
        ColorNameIndexMap["darkgreen"] = 25;
        ColorNameIndexMap["darkkhaki"] = 26;
        ColorNameIndexMap["darkmagenta"] = 27;
        ColorNameIndexMap["darkolivegreen"] = 28;
        ColorNameIndexMap["darkorange"] = 29;
        ColorNameIndexMap["darkorchid"] = 30;
        ColorNameIndexMap["darkred"] = 31;
        ColorNameIndexMap["darksalmon"] = 32;
        ColorNameIndexMap["darkseagreen"] = 33;
        ColorNameIndexMap["darkslateblue"] = 34;
        ColorNameIndexMap["darkslategray"] = 35;
        ColorNameIndexMap["darkturquoise"] = 36;
        ColorNameIndexMap["darkviolet"] = 37;
        ColorNameIndexMap["deeppink"] = 38;
        ColorNameIndexMap["deepskyblue"] = 39;
        ColorNameIndexMap["dimgray"] = 40;
        ColorNameIndexMap["dodgerblue"] = 41;
        ColorNameIndexMap["firebrick"] = 42;
        ColorNameIndexMap["floralwhite"] = 43;
        ColorNameIndexMap["forestgreen"] = 44;
        ColorNameIndexMap["fuchsia"] = 45;
        ColorNameIndexMap["gainsboro"] = 46;
        ColorNameIndexMap["ghostwhite"] = 47;
        ColorNameIndexMap["gold"] = 48;
        ColorNameIndexMap["goldenrod"] = 49;
        ColorNameIndexMap["gray"] = 50;
        ColorNameIndexMap["green"] = 51;
        ColorNameIndexMap["greenyellow"] = 52;
        ColorNameIndexMap["honeydew"] = 53;
        ColorNameIndexMap["hotpink"] = 54;
        ColorNameIndexMap["indianred"] = 55;
        ColorNameIndexMap["indigo"] = 56;
        ColorNameIndexMap["ivory"] = 57;
        ColorNameIndexMap["khaki"] = 58;
        ColorNameIndexMap["lavender"] = 59;
        ColorNameIndexMap["lavenderblush"] = 60;
        ColorNameIndexMap["lawngreen"] = 61;
        ColorNameIndexMap["lemonchiffon"] = 62;
        ColorNameIndexMap["lightblue"] = 63;
        ColorNameIndexMap["lightcoral"] = 64;
        ColorNameIndexMap["lightcyan"] = 65;
        ColorNameIndexMap["lightgoldenrodyellow"] = 66;
        ColorNameIndexMap["lightgreen"] = 67;
        ColorNameIndexMap["lightgrey"] = 68;
        ColorNameIndexMap["lightpink"] = 69;
        ColorNameIndexMap["lightsalmon"] = 70;
        ColorNameIndexMap["lightseagreen"] = 71;
        ColorNameIndexMap["lightskyblue"] = 72;
        ColorNameIndexMap["lightslategray"] = 73;
        ColorNameIndexMap["lightsteelblue"] = 74;
        ColorNameIndexMap["lightyellow"] = 75;
        ColorNameIndexMap["lime"] = 76;
        ColorNameIndexMap["limegreen"] = 77;
        ColorNameIndexMap["linen"] = 78;
        ColorNameIndexMap["magenta"] = 79;
        ColorNameIndexMap["maroon"] = 80;
        ColorNameIndexMap["mediumaquamarine"] = 81;
        ColorNameIndexMap["mediumblue"] = 82;
        ColorNameIndexMap["mediumorchid"] = 83;
        ColorNameIndexMap["mediumpurple"] = 84;
        ColorNameIndexMap["mediumseagreen"] = 85;
        ColorNameIndexMap["mediumslateblue"] = 86;
        ColorNameIndexMap["mediumspringgreen"] = 87;
        ColorNameIndexMap["mediumturquoise"] = 88;
        ColorNameIndexMap["mediumvioletred"] = 89;
        ColorNameIndexMap["midnightblue"] = 90;
        ColorNameIndexMap["mintcream"] = 91;
        ColorNameIndexMap["mistyrose"] = 92;
        ColorNameIndexMap["moccasin"] = 93;
        ColorNameIndexMap["navajowhite"] = 94;
        ColorNameIndexMap["navy"] = 95;
        ColorNameIndexMap["oldlace"] = 96;
        ColorNameIndexMap["olive"] = 97;
        ColorNameIndexMap["olivedrab"] = 98;
        ColorNameIndexMap["orange"] = 99;
        ColorNameIndexMap["orangered"] = 100;
        ColorNameIndexMap["orchid"] = 101;
        ColorNameIndexMap["palegoldenrod"] = 102;
        ColorNameIndexMap["palegreen"] = 103;
        ColorNameIndexMap["paleturquoise"] = 104;
        ColorNameIndexMap["palevioletred"] = 105;
        ColorNameIndexMap["papayawhip"] = 106;
        ColorNameIndexMap["peachpuff"] = 107;
        ColorNameIndexMap["peru"] = 108;
        ColorNameIndexMap["pink"] = 109;
        ColorNameIndexMap["plum"] = 110;
        ColorNameIndexMap["powderblue"] = 111;
        ColorNameIndexMap["purple"] = 112;
        ColorNameIndexMap["red"] = 113;
        ColorNameIndexMap["rosybrown"] = 114;
        ColorNameIndexMap["royalblue"] = 115;
        ColorNameIndexMap["saddlebrown"] = 116;
        ColorNameIndexMap["salmon"] = 117;
        ColorNameIndexMap["sandybrown"] = 118;
        ColorNameIndexMap["seagreen"] = 119;
        ColorNameIndexMap["seashell"] = 120;
        ColorNameIndexMap["sienna"] = 121;
        ColorNameIndexMap["silver"] = 122;
        ColorNameIndexMap["skyblue"] = 123;
        ColorNameIndexMap["slateblue"] = 124;
        ColorNameIndexMap["slategray"] = 125;
        ColorNameIndexMap["snow"] = 126;
        ColorNameIndexMap["springgreen"] = 127;
        ColorNameIndexMap["steelblue"] = 128;
        ColorNameIndexMap["tan"] = 129;
        ColorNameIndexMap["teal"] = 130;
        ColorNameIndexMap["thistle"] = 131;
        ColorNameIndexMap["tomato"] = 132;
        ColorNameIndexMap["turquoise"] = 133;
        ColorNameIndexMap["violet"] = 134;
        ColorNameIndexMap["wheat"] = 135;
        ColorNameIndexMap["white"] = 136;
        ColorNameIndexMap["whitesmoke"] = 137;
        ColorNameIndexMap["yellow"] = 138;
        ColorNameIndexMap["yellowgreen"] = 139;
        ColorNameIndexMap["zongse"] = 140;
        ColorNameIndexMap["zongse02"] = 141;
        ColorNameIndexMap["rouse"] = 142;
        ColorNameIndexMap["rouse02"] = 143;
        ColorNameIndexMap["lvse"] = 144;
        ColorNameIndexMap["hongse"] = 145;
        ColorNameIndexMap["lvse02"] = 146;
        ColorNameIndexMap["ublack"] = 147;
    }
})(gui || (gui = {}));
// TypeScript file
var gui;
...
(function (gui) {
    var GuiManager = (function (_super) {
        ...
        GuiManager.prototype.setDefaultFont = function (fontName) {
        };
        ...
        GuiManager.prototype.stopDriveTouch = function (x, y, touchPointID) {
            ...
            var event = new gui.GUIDriveEvent(gui.GUIDriveEvent.EndDriveEvent, driveTouchTarget);
            event.$initTo(x, y, touchPointID);
            event.setDriveOffXY(this.mDriveOffsetX, this.mDriveOffsetY);
            event.userData = userData;
            driveTarget.dispatchEvent(event);
            this.mDriveTargetSaveData = null;
        };
        ...
        GuiManager.prototype.stopTouch = function () {
            if (this.mTouchTarget) {
                this.mTouchTarget = null;
                this.mTouchBeginTime = -1;
            }
        ...
        GuiManager.prototype.initGuiTouchEvent = function () {
            ...
            egret.sys.TouchHandler.prototype.onTouchMove = function (x, y, touchPointID) {
                ...
                if (Math.abs(_this.mTouchX - x) > delta || Math.abs(_this.mTouchY - y) > delta) {
            ...
            egret.sys.TouchHandler.prototype.onTouchEnd = function (x, y, touchPointID) {
                ...
                //没有长按/没有移动/没有拖拉事件
                if (_this.mbFireLongTouch == false && _this.mbTouchMove == false && _this.mDriveTargetSaveData == null) {
...
(function (eui) {
    ...
    (function (override) {
        function _init() {
            //override eui.Image
            var _onAddToStage = eui.Image.prototype.$onAddToStage;
            ...
            var _measureContentBounds = eui.Image.prototype.$measureContentBounds;
            eui.Image.prototype.$measureContentBounds = function (bounds) {
                _measureContentBounds.call(this, bounds);
            ...
            while (this.m_intervalCurrentTime >= this.m_intervalTime) {
                ...
                if (loopFinish) {
                    if (this.m_bLoop == false)
                        this.m_bPlaying = false;
                    var event_1 = new gui.GUIEvent(AnimBox.AnimEndEvent, this);
    ...
    var BatchImage = (function (_super) {
        ...
        BatchImage.prototype.drawNumberString = function (image_prefix, strNumber, targetX, targetY, spaceX) {
            ...
            for (var s = 0; s < strNumber.length; s++) {
                ...
                var imageInfo = this._renderImage(image_name, targetX, targetY);
                if (imageInfo) {
...
(function (gui) {
    ...
    var Grid9Image = (function (_super) {
        ...
        Grid9Image.prototype.$setBitmapData = function (value) {
            ...
            if (this.$UIComponent && this.bAutoScale9Grid == true) {
                ...
                if (value) {
                    //九宫格拉伸，中间一个像素
                    //水平
                    var hCenter = Math.ceil(value._bitmapWidth / 2);
                    var left = hCenter - 1;
                    var right = hCenter + 1;
                    //垂直
                    var vCenter = Math.ceil(value._bitmapHeight / 2);
                    var top = vCenter - 1;
...
(function (gui) {
    var ModalColorLayer = (function (_super) {
        ...
        ModalColorLayer.prototype.$propagateFlagsUp = function (flags) {
            _super.prototype.$propagateFlagsUp.call(this, flags);
            //子类的位置改变了
            if (flags == 4 /* InvalidBounds */) {
                this.setNodeChange();
            }
        };
    ...
    var RichDisplayer = (function (_super) {
        ...
        RichDisplayer.prototype.translateWord = function (text) {
            ...
            for (var i = 0; i < length; i++) {
                ...
                if (i % 2 == 1 && i != length - 1) {
                    if (str != "") {
                        var event_2 = new gui.GUITranslateWordEvent(RichDisplayer.RichDisplayerTranslateEvent, this);
                        event_2.setTranslateWord(str);
                        this.dispatchEvent(event_2);
                        var transStr = event_2.getTranslateWord();
                        if (transStr == "") {
                            //strList[i] = transStr;
                            return text;
                        }
                ...
                this.mRowInfoList.forEach(function (rowInfo) {
                    rowInfo.mPosInfoList.forEach(function (posInfo) {
                        if (posInfo.window != null) {
                            _this.mContainer.removeChild(posInfo.window);
                            posInfo.window = null;
                        }
                    });
                });
                ...
                for (var i = 0; i < this.mRowInfoList.length; i++) {
                    ...
                    for (var j = 0; j < rowInfo.mPosInfoList.length; j++) {
                        ...
                        if (logicInfo.type == 1 /* TextType */) {
                            ...
                            if (animBox == null) {
                                animBox = new gui.AnimBox;
                                posInfo.window = animBox;
        ...
        RichDisplayer.prototype.onRdTouchTapCapture = function (event) {
            ...
            if (logicInfo && logicInfo.link != "") {
                var event_3 = new gui.GUIHyperlinkEvent(RichDisplayer.RichDisplayerLinkCmdEvent, this);
                event_3.setHyperlink(logicInfo.link);
    ...
    var ComboBox = (function (_super) {
        ...
        ComboBox.prototype.hide = function () {
            ...
            if (this.Scroller.parent) {
                //收起
                this.stage.removeChild(this.Scroller);
            }
        };
        /**
...
(function (core) {
    var NetSystem = (function (_super) {
        ...
        NetSystem.prototype.onUpdate = function () {
            ...
            this.mTcpListLock++;
            tcpList.forEach(function (nw) {
                nw.onUpdate();
            });
            this.mTcpListLock--;
            this.mHttpListLock++;
            httpList.forEach(function (hw) {
                hw.onUpdate();
            });
            this.mHttpListLock--;
        };
        NetSystem.prototype.clearAll = function () {
            this.mTcpList.forEach(function (nw) {
                nw.deleteObj();
            });
            this.mTcpList = null;
            this.mHttpList.forEach(function (hw) {
                hw.onUpdate();
            });
            this.mHttpList = null;
        };
...
(function (gui) {
    ...
    var ImageSet = (function (_super) {
        ...
        ImageSet.prototype.createSubTexture = function (baseTexture, bitmapX, bitmapY, bitmapWidth, bitmapHeight, offsetX, offsetY, textureWidth, textureHeight) {
            ...
            texture._bitmapData = baseTexture._bitmapData;
            texture.$initData(bitmapX, bitmapY, bitmapWidth, bitmapHeight, offsetX, offsetY, textureWidth, textureHeight, baseTexture._sourceWidth, baseTexture._sourceHeight);
            return texture;
        };
...
(function (egret) {
    ...
    (function (override) {
        function _init() {
            ...
            var _onAddToStage = egret.Bitmap.prototype.$onAddToStage;
            egret.Bitmap.prototype.$onAddToStage = function (stage, nestLevel) {
                var bitmapData = this.$Bitmap[1 /* image */];
                if (bitmapData && bitmapData.source == null) {
            ...
            egret.BitmapData.$removeDisplayObject = function (displayObject, bitmapData) {
                ...
                var tempList = _displayList[hashCode];
                var index = tempList.indexOf(displayObject);
                if (index >= 0) {
                    tempList.splice(index, 1); //引擎有BUG，这里重载函数
                }
            };
        }
        override._init = _init;
...
(function (core) {
    ...
    var NetWork = (function (_super) {
        ...
        NetWork.prototype.connect = function (server, port) {
            ...
            this.destorySocket();
            this.socket = this.createSocket();
            this.socket.connectByUrl("ws://" + server + ":" + port);
            this.mClosing = false;
        ...
        NetWork.prototype.onReceiveMessage = function (e) {
            ...
            while (recvLen >= this.PACKET_HEADER_SIZE) {
                var nPacketSize = recvBuffDataview.getInt16(0, litter_endian); //wDataSize
        ...
        NetWork.prototype.onUpdate = function () {
            ...
            if (this.mRecvResultList.length != 0) {
                this.mRecvResultList.forEach(function (result) {
                    switch (result.state) {
                        case NetWorkResultState.Connect:
                            {
                                ...
                                connetEvent.net = _this;
                                _this.fireEvent(NetWork.ConnectEvent, connetEvent);
                        ...
                        case NetWorkResultState.Close:
                            {
                                ...
                                closeEvent.net = _this;
                                _this.fireEvent(NetWork.CloseEvent, closeEvent);
                        ...
                        case NetWorkResultState.Normal:
                            {
                                ...
                                _this.fireNetMsg(result.buffer);
                            }
                            break;
                    }
                    result.deleteObj();
...
var CrossJsonP = (function () {
    ...
    CrossJsonP.localCallback = function (relatePath, data) {
        var url = RES.$getVirtualUrl(relatePath);
...
(function (core) {
    ...
    core.CrossJsonpImageAnalyzer = CrossJsonpImageAnalyzer;
    __reflect(CrossJsonpImageAnalyzer.prototype, "core.CrossJsonpImageAnalyzer");
})(core || (core = {}));
var map;
(function (map) {
    var TileMap = (function (_super) {
        ...
        TileMap.prototype.updateCameraView = function () {
            var _this = this;
            this.mLayerList.forEach(function (layer) {
                layer.onUpdate(_this.mCamera);
            });
...
(function (map) {
        ...
        MapAreaAnimNode.prototype.update = function (timeStamp) {
            ...
            if (this.during >= this.delay) {
                ...
                if (this.mFramesTexture[this.index] == null) {
                    ...
                    var texture = new egret.Texture();
                    texture._bitmapData = baseTexture._bitmapData;
                    texture.$initData(frame.x, frame.y, frame.w, frame.h, frame.offX, frame.offY, frame.sourceW, frame.sourceH, baseTexture._sourceWidth, baseTexture._sourceHeight);
    ...
    //粒子系统
    var MapAreaParticleNode = (function (_super) {
        __extends(MapAreaParticleNode, _super);
        function MapAreaParticleNode() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
        MapAreaParticleNode.prototype.initWithName = function (name) {
            var info = this.mMapMgr.getAreaParticleConfig(name);
            if (info == null || !info.path) {
        ...
        MapAreaParticleNode.prototype.clear = function () {
            _super.prototype.clear.call(this);
            if (this.system) {
        ...
        MapAreaParticleNode.prototype.onLoadComplete = function () {
            this.system = new particle.GravityParticleSystem(this.textureRes.getData(), this.jsonRes.getData());
            this.addChild(this.system);
            this.system.start();
        };
        return MapAreaParticleNode;
    }(MapAreaElemResNode));
    map.MapAreaParticleNode = MapAreaParticleNode;
    __reflect(MapAreaParticleNode.prototype, "map.MapAreaParticleNode");
})(map || (map = {}));
var map;
(function (map) {
    ...
    var MapAreaElem = (function (_super) {
        ...
        MapAreaElem.prototype.createElemNode = function (objectType, name) {
            ...
            if (objectType == "frame_anim") {
                ...
                elemNode = new map.MapAreaParticleNode();
            }
            if (elemNode) {
...
(function (core) {
    var ResGroup = (function (_super) {
        ...
        ResGroup.prototype.load = function () {
            ...
            if (this.mResCallback != null)
                return;
            var all = Object.keys(this.mResItemMap).length;
            var count = 0;
            var callback = {
                onResItemLoad: function (res) {
                    var info = _this.mResItemMap[res.getKey()];
                    if (info) {
        ...
        ResGroup.prototype.unload = function () {
            if (this.mbLoaded == false && this.mResCallback == null)
                return;
            this.mbLoaded = false;
...
(function (map) {
    var MapTile = (function (_super) {
        ...
        MapTile.prototype.onTileFound = function (layer) {
            ...
            if (path != "") {
                // core.ResManager.getInstance().loadResAsyn(path, this, 
                // 								core.ResourceType.TYPE_IMAGE);
                var textureMgr = core.TextureManager.getInstance();
...
var Application = (function (_super) {
    ...
    Application.prototype.isDeviceMobile = function () {
        return egret.MainContext.deviceType == egret.MainContext.DEVICE_MOBILE;
    };
    Application.prototype.isDeviceWeb = function () {
        return egret.MainContext.deviceType == egret.MainContext.DEVICE_PC;
    };
    Application.prototype.isRuntimeHtml5 = function () {
        return egret.MainContext._runtimeType == egret.MainContext.RUNTIME_HTML5;
    };
    Application.prototype.isRuntimeNative = function () {
        return egret.MainContext._runtimeType == egret.MainContext.RUNTIME_NATIVE;
    };
    ...
    var LogicSpriteManager = (function (_super) {
        ...
        LogicSpriteManager.prototype.destory = function () {
            ...
            for (var k in this.mTextureResourceMap) {
                var texRes = this.mTextureResourceMap[k];
                texRes.deleteObj();
            }
            this.mSkeletonResourceMap = {};
        };
        ...
        LogicSpriteManager.prototype.getBoneTextureResource = function (modelName) {
            var info = this.mModelInfoMap[modelName];
            //TLog.Assert(!path, "loadResouce:" + modelName);
            if (modelName == null || info == null) {
                return null;
            ...
            if (res == null) {
                res = map.BoneSpriteTextureResource.newObj(modelName, info, this);
        ...
        LogicSpriteManager.prototype.onUpdate = function () {
            ...
            if (this.mUnloadingResourceList.length > 0) {
                ...
                for (var _i = 0, _a = this.mUnloadingResourceList; _i < _a.length; _i++) {
                    var res = _a[_i];
                    if (res.mUnLoadBeginTime > 0 && res.mUnLoadBeginTime < validTime) {
...
(function (map) {
    var BoneSprite = (function (_super) {
        ...
        BoneSprite.prototype._loadTextureResource = function () {
        ...
        BoneSprite.prototype._unLoadTextureResource = function () {
        ...
        BoneSprite.prototype._updateSlotDisplay = function (isDelete) {
            isDelete = !!isDelete;
            ...
            for (var i = 0; i < slots.length; i++) {
                ...
                for (var i_1 = 0, l = slotDisplayDataSet.length; i_1 < l; ++i_1) {
                    var displayData = slotDisplayDataSet[i_1];
        ...
        BoneSprite.prototype._updateTexture = function () {
            ...
            do {
                if (boneName != "" && boneName != null) {
                    ...
                    if (slot == null) {
                        ...
                        slot.init(slotData, [], new egret.Bitmap(), new egret.Mesh());
...
(function (map) {
    ...
    __reflect(BoneSpriteSkletonResource.prototype, "map.BoneSpriteSkletonResource", ["core.ResItemCallback"]);
    //纹理资源
    var BoneSpriteTextureResource = (function (_super) {
        __extends(BoneSpriteTextureResource, _super);
        function BoneSpriteTextureResource() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
        //子类复写 初始化函数
        BoneSpriteTextureResource.prototype.initObj = function () {
            var params = [];
            for (var _i = 0; _i < arguments.length; _i++) {
                params[_i] = arguments[_i];
            }
        ...
        //子类复写 析构函数
        BoneSpriteTextureResource.prototype.destory = function () {
        ...
        BoneSpriteTextureResource.prototype._loadImp = function () {
            var resMgr = core.ResManager.getInstance();
        ...
        BoneSpriteTextureResource.prototype._unloadImp = function () {
            var factory = dragonBones.EgretFactory.factory;
            if (this.textureAtlasData) {
                factory.removeTextureAtlasData(this.textureAtlasData.name);
                this.textureAtlasData = null;
                //清理骨架下所有图片信息
                var name_3 = this.mModelName;
                var dragonBonesData = factory.getDragonBonesData(name_3);
                if (dragonBonesData) {
                    var armatures = dragonBonesData.armatures;
                    for (var k in armatures) {
                        var armatureData = armatures[k];
                        if (armatureData) {
                            //所有皮肤
                            for (var skinName in armatureData.skins) {
                                var skinData = armatureData.skins[skinName];
                                //皮肤下的skinSlot
                                for (var skinSlotName in skinData.displays) {
                                    var displayDataList = skinData.displays[skinSlotName];
                                    //display的texture清空
                                    for (var _i = 0, displayDataList_1 = displayDataList; _i < displayDataList_1.length; _i++) {
                                        var displayData = displayDataList_1[_i];
                                        if (displayData instanceof dragonBones.ImageDisplayData) {
        ...
        BoneSpriteTextureResource.prototype._cancelLoadImp = function () {
            var resMgr = core.ResManager.getInstance();
            resMgr.cancelResAsyn(this);
            var textureMgr = core.TextureManager.getInstance();
            textureMgr.cancelTextureAsyn(this.texturePath, this);
        };
        BoneSpriteTextureResource.prototype.onResItemLoad = function (res) {
        ...
        BoneSpriteTextureResource.prototype.onResItemError = function (key) {
        };
        BoneSpriteTextureResource.prototype.onAsynTextureSucceed = function (key, texture, textureRes) {
        ...
        BoneSpriteTextureResource.prototype._updateRes = function () {
            if (this.textureJsonRes &&
                this.textureRes) {
                var factory = dragonBones.EgretFactory.factory;
        ...
        return BoneSpriteTextureResource;
    }(map.SpriteResourceBase));
    map.BoneSpriteTextureResource = BoneSpriteTextureResource;
    __reflect(BoneSpriteTextureResource.prototype, "map.BoneSpriteTextureResource", ["core.ResItemCallback", "core.TextureCallback"]);
})(map || (map = {}));
var map;
(function (map) {
    var FrameSprite = (function (_super) {
        ...
        FrameSprite.prototype.onAnimationIndexChange = function (actionId, index) {
            this.mSpriteDisplay.setFrameIndex(actionId, index);
        };
        //-----------------------------------内部函数------------------------------------------------
...
(function (map) {
    ...
    var FramSpriteBodyPartDisplayBase = (function (_super) {
        ...
        FramSpriteBodyPartDisplayBase.prototype.setFrameIndex = function (actionId, index) {
            this.mActionId = actionId;
    ...
    var FramSpriteBodyPartDisplayProxy = (function (_super) {
        ...
        FramSpriteBodyPartDisplayProxy.prototype.setFrameIndex = function (actionId, index) {
            // this.mActionId = actionId;
            // this.mFrameIndex = index;
            //this.updateDislay()
        };
    ...
    var FrameSpriteDisplay = (function (_super) {
        ...
        FrameSpriteDisplay.prototype.setFrameIndex = function (actionId, index) {
            for (var _i = 0, _a = this.mBodyPartDisplayList; _i < _a.length; _i++) {
                var bodyPartDisplay = _a[_i];
                bodyPartDisplay.setFrameIndex(actionId, index);
            }
            this.mActionId = actionId;
            this.mFrameIndex = index;
        };
        ...
        FrameSpriteDisplay.prototype.addBodyPartDisplay = function (display) {
            if (JsUtil.arrayPush(this.mBodyPartDisplayList, display)) {
                ...
                display.setFrameIndex(this.mActionId, this.mDirIndex);
                return true;
            }
            return false;
        };
...
(function (map) {
    ...
    var FrameSpriteTextureResource = (function (_super) {
        ...
        FrameSpriteTextureResource.prototype.isAnimTextureLoaded = function (animName) {
            ...
            return res != null && res.textureRes != null;
        };
        ...
        FrameSpriteTextureResource.prototype._createTextureAtlas = function (res) {
            ...
            for (var key in jsonData.frames) {
                ...
                subtexture._bitmapData = textureAtlas._bitmapData;
                subtexture.$initData(data.x, data.y, data.w, data.h, data.offX, data.offY, data.sourceW, data.sourceH, textureAtlas._sourceWidth, textureAtlas._sourceHeight);
...
(function (core) {
    ...
    var GameSdk = (function (_super) {
        ...
        GameSdk.prototype.initSdk = function (json) {
            ...
            if (defineClass) {
                this.mInterGameSdk = defineClass.newObj(this);
            }
        ...
        GameSdk.prototype.reportRoleCreate = function (serverId, serverName, roleId, roleName) {
            if (this.mInterGameSdk == null)
                return false;
            return this.mInterGameSdk.reportRoleCreate(serverId, serverName, roleId, roleName, 1);
        };
        GameSdk.prototype.reportRoleLogin = function (serverId, serverName, roleId, roleName, roleLevel) {
            if (this.mInterGameSdk == null)
                return false;
            return this.mInterGameSdk.reportRoleLogin(serverId, serverName, roleId, roleName, roleLevel);
        };
        //////////////////////////////////////////////////////////////////////////////
        //////////////////////////////////////////////////////////////////////////////
        // setSkip(qd: string) {
        ...
        GameSdk.prototype.onLoginReturn = function (ret, params) {
            if (ret == 0) {
                params = params + this._loginSuccessAppead;
            }
