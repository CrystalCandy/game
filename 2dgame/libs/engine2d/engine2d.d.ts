...
declare module core {
    ...
    class ResManager extends TClass {
        ...
        private mbH5CrossOrign;
        private mErrorResPathMap;
        initObj(...params: any[]): void;
        init(): void;
        destory(): void;
        setRootPath(rootPath: string): void;
        getRootPath(rootPath: any): string;
        ...
        fetchVersion(cb: Function, thisObj: any, userData?: any): void;
        ...
        addZipPacket(key: string, callback?: ZipItemCallback): void;
        getZipPacketCount(): number;
        startH5CrossOrigin(crossRootPath: string): void;
...
declare module core {
    ...
    class TextureManager extends core.EventSet implements ResItemCallback {
        ...
        checkBitmapRefrence(bitmapData: egret.BitmapData): number;
        onUpdate(): void;
    }
}
declare module core {
...
declare class TXML {
    static parse(data: string): egret.XML;
...
declare module gui {
    class BatchImage extends eui.Component {
        ...
        beginDraw(): void;
        endDraw(): void;
        _renderImage(name: string, xPos: number, yPos: number): gui.ImageInfo;
        _renderProgress(name: string, xPos: number, yPos: number, progress: number, isVertical: boolean): gui.ImageInfo;
...
declare module gui {
    class RichDisplayer extends eui.Group {
        ...
        mDefaultFontFlag: number;
        mReplaceArr: any[];
        mAlignFlag: number;
        mContainer: eui.Group;
        mContentChanged: boolean;
        mRowDistance: number;
        constructor();
...
declare class CrossJsonP {
    private static mLocalCall;
    static sendLocal(url: string, callback: Function, callobj: any): void;
    static localCallback(relatePath: string, data: string): void;
}
declare module core {
    class CrossJsonpImageAnalyzer extends RES.ImageAnalyzer {
         ...
         * @inheritDoc
         */
        loadFile(resItem: any, compFunc: any, thisObject: any): void;
        private onLoadError(url);
        private onLoadOk(url, base64);
    }
}
declare module map {
...
declare module map {
    ...
    class MapAreaParticleNode extends MapAreaElemResNode {
...
declare class Application extends TClass {
    ...
    isDeviceWeb(): boolean;
    isRuntimeHtml5(): boolean;
    isRuntimeNative(): boolean;
    onUpdate(): void;
}
...
declare module map {
    class LogicSpriteManager extends core.EventSet {
        ...
        getBoneTextureResource(modelName: any): BoneSpriteTextureResource;
...
declare module map {
    class BoneSprite extends map.LogicSprite {
        ...
        initObj(...params: any[]): void;
        destory(): void;
        _loadTextureResource(): void;
        _unLoadTextureResource(): void;
        _loadSkeletonResource(): void;
        _unLoadSkeletonResource(): void;
        private onFrameEvent(event);
        private onAnimationEvent(event);
        private _createArmature();
        private _clearArmature();
        private _updateAnimation();
        private _getTextureData(textureName);
        private _updateSlotDisplay(isDelete?);
        private _updateTexture();
        private _updateBound();
        private _updatePartSkin(slotName, replaceSkinPath);
        private _updateSkin();
        private _createDynamicSlotData(name, parent);
...
declare module map {
    class BoneSpriteSkletonResource extends SpriteResourceBase implements core.ResItemCallback {
    ...
    class BoneSpriteTextureResource extends SpriteResourceBase implements core.ResItemCallback, core.TextureCallback {
...
declare module map {
    class FramSpriteBodyPartDisplayBase extends egret.DisplayObjectContainer {
        ...
        setFrameIndex(actionId: string, index: number): void;
...
declare module core {
    ...
    class GameSdk extends core.EventSet {
        ...
        reportRoleCreate(serverId: string, serverName: string, roleId: string, roleName: string): boolean;
