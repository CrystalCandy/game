...
数据结构定义 与函数命名
{
    ...
    "method":{
		...
		"G2C_Proposal":"uint32;string;uint32",	--求婚者Id, 求婚者名字, 求婚类型,
		"C2G_PromiseMarry":"uint32;uint32;uint8",	--求婚者Id, 求婚类型, 是否答应 0不答应
		"G2C_PromiseMarry":"string;string",		--通知答应了求婚
		...
		"G2C_ReceiveExp":"",	
		"C2G_ChuShi":"uint32;uint8;uint16",	--出师，徒弟Id，是否强制出师(1不是), 出师类型(读表)
		"G2C_ChuShi":"",
		"C2G_UpdateShitu":"",	--更新师徒信息(所有数据)
		"G2C_UpdateShitu":"table;table", --师傅数据，两个徒弟数据
		
		--法宝
		"C2G_EquipTalismanSet":"uint8,uint8",					--穿上物品
		"C2G_EquipTalismanUp":"uint8",						--请求法宝升级  索引位置
		"C2G_EquipTalismanCreate":"uint8",				--打造物品  1为普通打造  2为完美打造
		"C2G_EquipTalismanResolve":"table",				--法宝分解 分解列表
		"C2G_EquipTalismanLock":"uint16,uint8",			--法宝上锁  1位物品id 2为(0是解锁,1上锁)
